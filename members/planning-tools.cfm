            ...
            <form method="post" action="/members/planning-tools.cfm">
                ...
                <div style="display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:16px;margin-bottom:16px">
                    ...
                    <div class="field">
                        ...
                        <input type="text" id="dueDate" name="dueDate" class="flatpickr-date" readonly placeholder="Select a date">
                    </div>
                    <div class="field">
...
<script>flatpickr(document.getElementById('dueDate'), { dateFormat: 'Y-m-d', allowInput: false, disableMobile: true });</script>
