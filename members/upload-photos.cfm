...
<cfif !directoryExists(uploadDir)>
    ...
    <cfcatch type="any">
        <cfset arrayAppend(errors, "Could not create upload folder: " & cfcatch.message)>
    </cfcatch>
    </cftry>
</cfif>
...
<cfcatch type="any">
    <cfset arrayAppend(errors, "Hero upload failed: " & cfcatch.message)>
</cfcatch>
</cftry>
</cfif>
...
<cfcatch type="any">
    <cfset arrayAppend(errors, "Couple photo upload failed: " & cfcatch.message)>
</cfcatch>
</cftry>
</cfif>
...
<cfcatch type="any">
    <cfset arrayAppend(errors, "Gallery upload failed: " & cfcatch.message)>
</cfcatch>
</cftry>
</cfif>
