...
<div class="container">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
        <a href="/members/admin/users.cfm" style="text-decoration:none">
        ...
        <a href="/members/admin/vendors.cfm" style="text-decoration:none">
            <div class="panel" style="cursor:pointer;transition:border-color .2s" onmouseover="this.style.borderColor='var(--gold)'" onmouseout="this.style.borderColor=''">
        ...
        <a href="/members/admin/vendor-invite.cfm" style="text-decoration:none">
            <div class="panel" style="cursor:pointer;transition:border-color .2s" onmouseover="this.style.borderColor='var(--gold)'" onmouseout="this.style.borderColor=''">
        ...
        <a href="/members/admin/db.cfm" style="text-decoration:none">
            <div class="panel" style="cursor:pointer;transition:border-color .2s" onmouseover="this.style.borderColor='var(--gold)'" onmouseout="this.style.borderColor=''">
