...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%">
  ...
  <tr><td align="center" style="background:##FDFBF7;padding:44px 48px 40px">
    ...
    <tr><td style="background:##e8f0e9;border:1px solid ##b2cbb5;border-radius:6px;padding:16px 20px">
      <p style="margin:0;color:##3a5e3e;font-size:14px;line-height:1.6;font-family:Arial,Helvetica,sans-serif">
