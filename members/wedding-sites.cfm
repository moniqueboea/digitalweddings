...
<div class="container">
    ...
    <!--- ===== TEMPLATE GRID ===== --->
    <h2 style="font-size:22px;font-weight:700;font-family:var(--font-heading);margin-bottom:24px">
        <cfif sites.recordCount>Create Another Site<cfelse>Choose a Template</cfif>
    </h2>
    ...
    <div class="tpl-grid">
        ...
        <div class="tpl-card" style="border:2px solid #D4478A">
            <div class="tpl-img-wrap">
                <img src="/assets/aka-inspired.jpg" alt="AKA Inspired" onerror="this.style.background='#1A6B3C'">
                <div class="tpl-overlay">
                    <a href="/members/preview-template.cfm?template=aka_inspired" target="_blank" class="tpl-btn-preview"><i data-lucide="eye" style="width:14px;height:14px"></i>Preview</a>
                    <a href="/members/wedding-site-edit.cfm?template=aka_inspired" class="tpl-btn-select"><i data-lucide="check" style="width:14px;height:14px"></i>Select</a>
                </div>
            </div>
            <div class="tpl-card-body">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
                    <p class="tpl-name">AKA Inspired</p>
                    <div style="display:flex;gap:5px"><span class="color-dot" style="background:#1A6B3C"></span><span class="color-dot" style="background:#D4478A"></span><span class="color-dot" style="background:#FDF5F8"></span></div>
                </div>
                <p class="tpl-desc">Ivy &amp; pearls on blush pink &mdash; forest green and rose accents with an elegant, romantic feel.</p>
            </div>
        </div>

        <div class="tpl-card" style="border:2px solid #CC0000">
            <div class="tpl-img-wrap">
                <img src="/assets/delta-inspired.jpg" alt="Delta Inspired" onerror="this.style.background='#8B0000'">
                <div class="tpl-overlay">
                    <a href="/members/preview-template.cfm?template=delta_inspired" target="_blank" class="tpl-btn-preview"><i data-lucide="eye" style="width:14px;height:14px"></i>Preview</a>
                    <a href="/members/wedding-site-edit.cfm?template=delta_inspired" class="tpl-btn-select"><i data-lucide="check" style="width:14px;height:14px"></i>Select</a>
                </div>
            </div>
            <div class="tpl-card-body">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
                    <p class="tpl-name">Delta Inspired</p>
                    <div style="display:flex;gap:5px"><span class="color-dot" style="background:#CC0000"></span><span class="color-dot" style="background:#F8F4F0"></span><span class="color-dot" style="background:#1A0A0A"></span></div>
                </div>
                <p class="tpl-desc">Red satin &amp; pearls &mdash; bold crimson with pearl accents on a rich fixed background.</p>
            </div>
        </div>
