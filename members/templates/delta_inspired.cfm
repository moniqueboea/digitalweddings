<!---
  delta_inspired.cfm — Red satin & pearls, garden_romance structure
  Palette: crimson #CC0000, pearl #F8F4F0, cream #FDF8F6, deep #1A0A0A
--->
...
<style>
:root{--white:#FFFFFF;--cream:#FDF8F6;--pearl:#F0EAE6;--crimson:#CC0000;--deep:#1A0A0A;--muted:rgba(26,10,10,.65)}
...
.page-bg{
  ...
  inset:0;
  z-index:0;
  background-image:url('/assets/delta-inspired.jpg');
...
nav a{color:rgba(255,255,255,.8);text-decoration:none;font-size:.78rem;letter-spacing:.16em;text-transform:uppercase;display:inline-block;padding:18px 16px;border-bottom:2px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap;font-family:'Jost',sans-serif}
nav a:hover,nav a.active{color:#fff;border-bottom-color:rgba(255,255,255,.6)}

/* ---- PEARL STRIPE (decorative) ---- */
.pearl-stripe{
  height:18px;
  background:repeating-linear-gradient(
    ...
    transparent 0px,
    transparent 6px,
    radial-gradient(circle at 50% 50%, #fff 0%, #e8e0dc 40%, #c8b8b0 100%) 6px,
    radial-gradient(circle at 50% 50%, #fff 0%, #e8e0dc 40%, #c8b8b0 100%) 18px
  );
...
.hero{
  ...
  background:rgba(253,248,246,.55);
  backdrop-filter:blur(4px);
}
.hero-eyebrow{font-size:.78rem;letter-spacing:.38em;text-transform:uppercase;color:var(--crimson);margin-bottom:20px;display:block;font-family:'Jost',sans-serif}
...
.hero-rule .line{height:1px;width:60px;background:var(--crimson);opacity:.35}
.hero-rule .pearl{
  width:10px;height:10px;border-radius:50%;
  background:radial-gradient(circle at 35% 35%, #fff 0%, #e8e0dc 40%, #c0a8a0 100%);
  box-shadow:0 1px 3px rgba(0,0,0,.2);
}
.hero-date{font-size:.88rem;letter-spacing:.28em;text-transform:uppercase;color:var(--muted);margin-bottom:8px}
.hero-venue{font-size:.85rem;letter-spacing:.16em;text-transform:uppercase;color:var(--crimson)}

/* ---- DIVIDER ---- */
.divider{height:1px;background:rgba(204,0,0,.12);margin:0}

/* ---- SECTIONS ---- */
.section{padding:88px 56px;max-width:860px;margin:0 auto;text-align:center;background:rgba(253,248,246,.55);backdrop-filter:blur(6px)}
.section-sheer{padding:88px 56px;max-width:860px;margin:0 auto;text-align:center;background:rgba(253,248,246,.55);backdrop-filter:blur(6px)}
.section-sheer .inner{max-width:100%;margin:0 auto;text-align:center}

.section-title{margin-bottom:52px}
.section-title .eyebrow{font-size:.8rem;letter-spacing:.28em;text-transform:uppercase;color:var(--crimson);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
...
.pearl-rule{display:flex;align-items:center;justify-content:center;gap:8px;margin-top:16px}
.pearl-rule .line{height:1px;width:44px;background:var(--crimson);opacity:.3}
.pearl-rule .pearl{
...
/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:rgba(204,0,0,.15);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:150px;padding:48px 32px;background:rgba(253,248,246,.55);text-align:center;backdrop-filter:blur(4px)}
.detail-block .lbl{font-size:.78rem;letter-spacing:.28em;text-transform:uppercase;color:var(--crimson);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
...
.faq-item{padding:28px 0;border-bottom:1px solid rgba(204,0,0,.1)}
...
.link-btn{display:inline-block;margin-top:28px;padding:13px 36px;border:1px solid var(--crimson);color:var(--crimson);text-decoration:none;font-size:.78rem;letter-spacing:.22em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--crimson);color:#fff}
...
.rsvp-section .bg img{width:100%;height:100%;object-fit:cover;object-position:center;filter:brightness(.25) saturate(.8)}
.rsvp-section .content{position:relative;z-index:2}
.rsvp-section .eyebrow{font-size:.78rem;letter-spacing:.28em;text-transform:uppercase;color:rgba(255,255,255,.7);display:block;margin-bottom:16px}
.rsvp-section .script{font-family:'Great Vibes',cursive;font-size:2.6rem;color:rgba(255,200,200,.9);display:block;margin-bottom:8px}
.rsvp-section h2{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(2.6rem,5vw,4.4rem);font-weight:300;color:#fff;margin-bottom:16px;letter-spacing:.03em;font-style:italic}
.rsvp-section p{color:rgba(255,255,255,.6);margin-bottom:44px;max-width:400px;margin-left:auto;margin-right:auto;font-size:1rem;line-height:2}
.rsvp-btn{display:inline-block;padding:15px 56px;border:1px solid rgba(255,255,255,.7);color:#fff;font-size:.78rem;letter-spacing:.28em;text-transform:uppercase;text-decoration:none;font-family:'Jost',sans-serif;transition:background .25s,color .25s}
.rsvp-btn:hover{background:#fff;color:var(--deep)}

/* ---- FOOTER ---- */
footer{text-align:center;padding:72px 24px;border-top:1px solid rgba(204,0,0,.12);background:rgba(253,248,246,.55);backdrop-filter:blur(12px)}
...
footer .credit{font-size:1.1rem;color:rgba(26,10,10,.2);margin-top:24px}

/* ---- LIGHTBOX ---- */
#lightbox{position:fixed;inset:0;background:rgba(26,10,10,.97);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#8B0000;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=delta_inspired" style="padding:8px 20px;background:#CC0000;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
<div style="height:48px"></div>
</cfif>

<div class="pearl-stripe"></div>
...
<div class="hero">
  ...
  <img src="<cfoutput>#HTMLEditFormat(couplePhotoSrc)#</cfoutput>" alt="Couple photo" style="width:130px;height:130px;border-radius:50%;object-fit:cover;border:3px solid rgba(204,0,0,.4);box-shadow:0 0 0 5px rgba(204,0,0,.1),0 6px 28px rgba(0,0,0,.2);display:block;margin-bottom:22px">
...
<section class="section" id="our_story">
  <div class="section-title">
    ...
    <h2>Our Story</h2>
    <div class="pearl-rule"><div class="line"></div><div class="pearl"></div><div class="pearl"></div><div class="pearl"></div><div class="line"></div></div>
  </div>
...
<!--- DETAILS --->
<div class="divider"></div>
<section id="details" style="padding:88px 56px;max-width:860px;margin:0 auto;background:rgba(253,248,246,.55);backdrop-filter:blur(6px);text-align:center">
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/delta-inspired.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
...
<button onclick="window.scrollTo({top:0,behavior:'smooth'})" id="backToTop" aria-label="Back to top" style="display:none;position:fixed;bottom:28px;right:28px;z-index:9000;width:44px;height:44px;border-radius:50%;border:none;cursor:pointer;background:rgba(204,0,0,.85);color:#fff;font-size:20px;line-height:44px;text-align:center;box-shadow:0 4px 16px rgba(204,0,0,.35);transition:opacity .2s">&#8679;</button>
