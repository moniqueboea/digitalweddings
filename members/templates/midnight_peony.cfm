<!---
  midnight_peony.cfm - dark moody pink peony template, midnight_rose style
  Palette: near-black #0A0608, deep charcoal #150E12, cream #F0EAE2, rose #C4707A
--->
...
<style>
:root{--black:#0A0608;--charcoal:#150E12;--cream:#F0EAE2;--rose:#C4707A;--muted:rgba(240,234,226,.5)}
...
.hero-nav a{color:rgba(240,234,226,.75);text-decoration:none;font-size:.6rem;letter-spacing:.22em;text-transform:uppercase;font-family:'Jost',sans-serif;font-weight:300;padding:10px 16px;border-bottom:1px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap}
...
.hero-date-line{font-size:.65rem;letter-spacing:.3em;text-transform:uppercase;color:rgba(240,234,226,.6);font-family:'Jost',sans-serif}
.hero-dot{width:3px;height:3px;border-radius:50%;background:var(--rose);flex-shrink:0}
.hero-venue-line{font-size:.65rem;letter-spacing:.2em;text-transform:uppercase;color:rgba(240,234,226,.5);font-family:'Jost',sans-serif}
...
.section-title .eyebrow{font-size:.58rem;letter-spacing:.35em;text-transform:uppercase;color:var(--rose);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
...
.rose-rule{width:40px;height:1px;background:var(--rose);margin-top:16px;opacity:.6}

/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:rgba(196,112,122,.2);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:150px;padding:48px 32px;background:var(--charcoal);text-align:center}
.detail-block .lbl{font-size:.62rem;letter-spacing:.28em;text-transform:uppercase;color:var(--rose);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
...
/* ---- STORY ---- */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2;color:rgba(240,234,226,.85);white-space:pre-wrap;font-style:italic;max-width:640px}
...
/* ---- TEXT BLOCKS ---- */
.text-body{font-size:.9rem;color:rgba(240,234,226,.75);line-height:2;white-space:pre-wrap;max-width:620px}
.link-btn{display:inline-block;margin-top:24px;padding:13px 36px;border:1px solid var(--rose);color:var(--rose);text-decoration:none;font-size:.6rem;letter-spacing:.28em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--rose);color:var(--black)}
...
.rsvp-section .eyebrow{font-size:.58rem;letter-spacing:.35em;text-transform:uppercase;color:var(--rose);display:block;margin-bottom:16px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#111;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid #333;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=midnight_peony" style="padding:8px 20px;background:#C4707A;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/midnight-peony.jpg" alt="Pink peonies" onerror="this.style.display='none'">
    </cfif>
  </div>
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/midnight-peony.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
