<!---
  delta_delta_love.cfm — Full-bleed hero image, Chi Omega cardinal red & gold accents
  Palette: dark #080F2A, deep #0D1A40, blue #1A3FA0, blue-light #A8C0F0, gold #C9A84C, gold-light #E8C97A, cream #FAF6EE
--->
...
.hero-overlay{position:absolute;inset:0;background:linear-gradient(to bottom,rgba(8,15,42,.5) 0%,rgba(8,15,42,.2) 40%,rgba(8,15,42,.85) 100%)}

/* Red & gold top border */
.hero-border{position:absolute;top:0;left:0;right:0;height:5px;z-index:5;background:linear-gradient(to right,var(--blue),var(--gold),var(--gold-light),var(--gold),var(--blue))}
...
.rsvp-section::before{content:'';position:absolute;top:0;left:0;right:0;height:4px;z-index:2;background:linear-gradient(to right,var(--blue),var(--gold),var(--gold-light),var(--gold),var(--blue))}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#080F2A;color:#FAF6EE;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid rgba(201,168,76,.3);gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=delta_delta_love" style="padding:8px 20px;background:#C9A84C;color:#080F2A;border-radius:4px;font-weight:700;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  ...
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/delta-delta-love.png" alt="Delta Delta Love" onerror="this.style.display='none'">
    </cfif>
  </div>
  ...
  <div class="hero-text">
    ...
    <img src="<cfoutput>#HTMLEditFormat(couplePhotoSrc)#</cfoutput>" alt="Couple photo"
      style="width:130px;height:130px;border-radius:50%;object-fit:cover;
             ...
             box-shadow:0 0 0 6px rgba(26,63,160,.2),0 4px 24px rgba(0,0,0,.6);
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/delta-delta-love.png" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
