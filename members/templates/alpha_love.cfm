<!---
  alpha_love.cfm — Full-bleed hero image, Alpha Phi Alpha black & gold
  Palette: dark #0A0A00, deep #111108, gold #C9A84C, gold-light #E8C97A, cream #FAF6EE
--->
...
.hero-overlay{position:absolute;inset:0;background:linear-gradient(to bottom,rgba(10,10,0,.45) 0%,rgba(10,10,0,.15) 40%,rgba(10,10,0,.82) 100%)}

/* Gold top border */
.hero-border{position:absolute;top:0;left:0;right:0;height:5px;z-index:5;background:linear-gradient(to right,var(--dark),var(--gold),var(--gold-light),var(--gold),var(--dark))}
...
.pearl-rule{width:60px;height:1px;background:linear-gradient(to right,transparent,var(--gold-light),transparent);margin-top:16px}
...
/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:rgba(201,168,76,.2);max-width:860px;margin:0 auto}
...
.link-btn:hover{background:var(--gold);color:var(--cream)}

/* ---- DIVIDER ---- */
.divider{width:100%;height:1px;background:linear-gradient(to right,transparent,var(--green),var(--gold-light),var(--green),transparent)}
...
.rsvp-section::before{content:'';position:absolute;top:0;left:0;right:0;height:4px;z-index:2;background:linear-gradient(to right,var(--green),var(--gold),var(--gold-light),var(--gold),var(--green))}
...
.rsvp-btn:hover{background:var(--gold);color:var(--cream)}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#0A0A00;color:#FAF6EE;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid rgba(201,168,76,.3);gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=alpha_love" style="padding:8px 20px;background:#C9A84C;color:#FAF6EE;border-radius:4px;font-weight:700;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  ...
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/alpha-love.jpg" alt="Alpha Love" onerror="this.style.display='none'">
    </cfif>
  </div>
  ...
  <div class="hero-text">
    ...
    <img src="<cfoutput>#HTMLEditFormat(couplePhotoSrc)#</cfoutput>" alt="Couple photo"
      style="width:130px;height:130px;border-radius:50%;object-fit:cover;
             ...
             box-shadow:0 0 0 6px rgba(201,168,76,.15),0 4px 24px rgba(0,0,0,.6);
...
<div style="position:relative;z-index:10;text-align:center;padding:18px 24px;border-bottom:1px solid rgba(201,168,76,.2);font-family:'Cinzel',serif">
  <span style="font-size:.6rem;letter-spacing:.4em;text-transform:uppercase;color:##E8C97A">Countdown</span>
  <div style="margin:6px 0;display:flex;align-items:baseline;justify-content:center;gap:8px">
    <span style="font-size:2.4rem;font-weight:600;color:##E8C97A;line-height:1">#cdDaysUntil#</span>
...
<div style="position:relative;z-index:10;text-align:center;padding:16px 24px;border-bottom:1px solid rgba(201,168,76,.2);font-family:'Cinzel',serif">
  <span style="font-size:.68rem;letter-spacing:.35em;text-transform:uppercase;color:##E8C97A">Today Is The Day</span>
</div>
</cfif>
</cfoutput>
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/alpha-love.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
