<!---
  kappa_love.cfm — Full-bleed hero image, Kappa Alpha Psi crimson & cream
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#1A0000;color:#FAF6EE;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid rgba(196,18,48,.3);gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=kappa_love" style="padding:8px 20px;background:#C41230;color:#FAF6EE;border-radius:4px;font-weight:700;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  ...
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/kappa-love.jpg" alt="Kappa Love" onerror="this.style.display='none'">
    </cfif>
  </div>
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/kappa-love.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
