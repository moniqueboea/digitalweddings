<!---
  rouge_peony.cfm — botanical peony corners on white
  Image 1: top-left corner | Image 2: bottom-right corner (mirrored)
  Palette: white #FEFEFE, blush #FAF0EE, rose #C4707A, crimson #8B2035, muted rgba(80,30,40,.42)
--->
...
<style>
:root{--white:#FEFEFE;--blush:#FAF0EE;--blush-dark:#EDD8D4;--rose:#C4707A;--crimson:#8B2035;--deep:#4A1020;--muted:rgba(80,30,40,.42)}
...
nav a:hover,nav a.active{color:var(--crimson);border-bottom-color:var(--rose)}
...
.sticky-nav a:hover,.sticky-nav a.active{color:var(--crimson);border-bottom-color:var(--rose)}
...
/* Corner florals — portrait images anchored to corners */
.peony-tl{position:absolute;top:0;left:0;height:75vh;width:auto;display:block;pointer-events:none;z-index:2}
.peony-tr{position:absolute;top:0;right:0;height:75vh;width:auto;display:block;pointer-events:none;z-index:2}
...
.hero-venue{font-size:.7rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(196,112,122,.7)}
...
.petal-rule .dot{width:5px;height:5px;border-radius:50%;background:var(--crimson);opacity:.4}
...
.link-btn{display:inline-block;margin-top:28px;padding:13px 36px;border:1px solid var(--rose);color:var(--crimson);text-decoration:none;font-size:.62rem;letter-spacing:.26em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
...
.rsvp-peony-l{position:absolute;bottom:0;left:0;height:80%;width:auto;opacity:.2;pointer-events:none}
.rsvp-peony-r{position:absolute;top:0;right:0;height:80%;width:auto;opacity:.2;pointer-events:none;transform:scale(-1)}
...
.rsvp-btn{display:inline-block;padding:15px 56px;background:var(--crimson);color:var(--white);font-size:.65rem;letter-spacing:.28em;text-transform:uppercase;text-decoration:none;font-family:'Jost',sans-serif;transition:background .25s}
...
footer .credit{font-size:1.1rem;font-weight:500;font-weight:500;color:rgba(80,30,40,.18);margin-top:24px}

/* ===== LIGHTBOX ===== */
#lightbox{position:fixed;inset:0;background:rgba(74,16,32,.97);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#4A1020;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=rouge_peony" style="padding:8px 20px;background:#8B2035;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<!--- HERO: white bg, peony image 1 top-left, image 2 bottom-right mirrored --->
<div class="hero" id="hero">
  <img src="/assets/rouge-peony-1.jpg" alt="" class="peony-tl" onerror="this.style.display='none'">
  <img src="/assets/rouge-peony-2.jpg" alt="" class="peony-tr" onerror="this.style.display='none'">
  <div class="hero-text">
