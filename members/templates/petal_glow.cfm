<!---
  petal_glow.cfm - soft pink peonies with bokeh, bordeaux_rose/midnight_peony style
  Palette: near-black #080608, charcoal #120810, cream #FBF2F5, blush #E8A0B8, muted rgba(251,242,245,.5)
--->
...
<style>
:root{--black:#080608;--charcoal:#120810;--cream:#FBF2F5;--blush:#E8A0B8;--muted:rgba(251,242,245,.5)}
...
.hero-overlay{position:absolute;inset:0;background:linear-gradient(to bottom,rgba(0,0,0,.52) 0%,rgba(0,0,0,.2) 40%,rgba(0,0,0,.75) 100%)}
...
.hero-nav a{color:rgba(251,242,245,.75);text-decoration:none;font-size:.75rem;letter-spacing:.18em;text-transform:uppercase;font-family:'Jost',sans-serif;font-weight:300;padding:10px 16px;border-bottom:1px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap}
...
.hero-date-line{font-size:.8rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(251,242,245,.6);font-family:'Jost',sans-serif}
.hero-dot{width:3px;height:3px;border-radius:50%;background:var(--blush);flex-shrink:0}
.hero-venue-line{font-size:.8rem;letter-spacing:.16em;text-transform:uppercase;color:rgba(251,242,245,.5);font-family:'Jost',sans-serif}
...
.section-title .eyebrow{font-size:.75rem;letter-spacing:.25em;text-transform:uppercase;color:var(--blush);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
...
.blush-rule{width:40px;height:1px;background:var(--blush);margin-top:16px;opacity:.6}

/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:rgba(232,160,184,.2);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:150px;padding:48px 32px;background:var(--charcoal);text-align:center}
.detail-block .lbl{font-size:.75rem;letter-spacing:.22em;text-transform:uppercase;color:var(--blush);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
...
/* ---- STORY ---- */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2;color:rgba(251,242,245,.85);white-space:pre-wrap;font-style:italic;max-width:640px}
...
/* ---- TEXT ---- */
.text-body{font-size:1rem;color:rgba(251,242,245,.75);line-height:2;white-space:pre-wrap;max-width:620px}
.link-btn{display:inline-block;margin-top:24px;padding:13px 36px;border:1px solid var(--blush);color:var(--blush);text-decoration:none;font-size:.75rem;letter-spacing:.2em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--blush);color:var(--black)}
...
.rsvp-section .bg img{width:100%;height:100%;object-fit:cover;filter:brightness(.2) saturate(.4)}
.rsvp-section .content{position:relative;z-index:2}
.rsvp-section .eyebrow{font-size:.75rem;letter-spacing:.25em;text-transform:uppercase;color:var(--blush);display:block;margin-bottom:16px}
...
#lightbox button{position:absolute;background:rgba(255,255,255,.08);border:none;color:var(--cream);cursor:pointer;font-family:'Jost',sans-serif}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#111;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid #333;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=petal_glow" style="padding:8px 20px;background:#E8A0B8;color:#080608;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/petal-glow.jpg" alt="Petal Glow" onerror="this.style.display='none'">
    </cfif>
  </div>
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/petal-glow.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
