...
<style>
:root{--black:#0D1117;--navy:#111B2E;--rose:#C4707A;--burgundy:#7D2235;--cream:#F8F0EC;--cream-dark:#EEE0D8;--gold:#C4A35A;--muted-cream:rgba(248,240,236,.55)}
*{margin:0;padding:0;box-sizing:border-box}
html{scroll-behavior:smooth}
body{background:var(--cream);color:var(--navy);font-family:'Jost',sans-serif;font-weight:300;line-height:1.7;overflow-x:hidden}

/* ===== PEONY HEADER & FOOTER IMAGES ===== */
.peony-header{display:block;height:clamp(320px,55vh,560px);width:auto;margin-left:auto}

/* ===== DARK HERO ===== */
.hero{position:relative;text-align:center;overflow:hidden;height:12vh;min-height:80px;display:flex;flex-direction:column}
.hero-bg{position:absolute;inset:0;background-image:url('/assets/dark-texture.jpg');background-size:cover;background-position:center;z-index:0}

/* NAV */
nav{background:var(--navy);border-bottom:1px solid rgba(196,163,90,.2);text-align:center}
nav a{color:rgba(248,240,236,.65);text-decoration:none;font-size:.88rem;letter-spacing:.14em;text-transform:uppercase;display:inline-block;padding:18px 16px;border-bottom:2px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap;font-family:'Jost',sans-serif}
nav a:hover,nav a.active{color:var(--gold);border-bottom-color:var(--gold)}

/* Sticky nav */
.sticky-nav{position:sticky;top:0;z-index:100;background:var(--navy);border-bottom:1px solid rgba(196,163,90,.2);display:none;text-align:center}
...
.hero-rule .line{height:1px;width:56px;background:var(--gold);opacity:.6}
.hero-rule .star{color:var(--gold);font-size:.85rem}
.hero-date{font-size:.72rem;letter-spacing:.3em;text-transform:uppercase;color:var(--muted-cream);margin-bottom:6px}
.hero-venue{font-size:.7rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(196,163,90,.65)}

/* ===== CONTENT SECTIONS ===== */
.section{padding:88px 56px;max-width:860px;margin:0 auto;text-align:center}
.section-dark{background:var(--navy);padding:88px 56px}
.section-dark .inner{max-width:860px;margin:0 auto;text-align:center}
.section-rose{background:var(--cream);padding:88px 56px}
.section-rose .inner{max-width:860px;margin:0 auto;text-align:center}
...
.gold-rule{display:flex;align-items:center;justify-content:center;gap:14px;margin-top:16px}
.gold-rule .line{height:1px;width:44px;background:var(--gold);opacity:.4}
.gold-rule .star{color:var(--gold);font-size:.7rem;opacity:.8}

/* ===== DETAILS ===== */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:var(--cream-dark);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:150px;padding:48px 32px;background:var(--cream);text-align:center}
.detail-block .lbl{font-size:.62rem;letter-spacing:.32em;text-transform:uppercase;color:var(--rose);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
.detail-block .val{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.7rem;font-weight:300;color:var(--navy);line-height:1.25;font-style:italic}
.detail-block .sub{font-size:.78rem;color:rgba(17,27,46,.45);margin-top:8px}

/* ===== STORY ===== */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2.1;color:var(--navy);white-space:pre-wrap;font-style:italic;max-width:620px;margin:0 auto}
...
.faq-item{padding:28px 0;border-bottom:1px solid rgba(196,163,90,.2)}
.faq-item .q{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.15rem;font-weight:600;color:var(--cream);margin-bottom:8px;font-style:italic}
.faq-item .a{font-size:.88rem;color:rgba(248,240,236,.55);line-height:1.9}

/* ===== TEXT ===== */
.text-body{font-size:.92rem;color:var(--navy);line-height:2;white-space:pre-wrap;max-width:600px;margin:0 auto;opacity:.75}
.text-body-light{font-size:.92rem;color:rgba(248,240,236,.6);line-height:2;white-space:pre-wrap;max-width:600px;margin:0 auto}
.link-btn{display:inline-block;margin-top:28px;padding:13px 36px;border:1px solid var(--rose);color:var(--rose);text-decoration:none;font-size:.62rem;letter-spacing:.26em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--rose);color:var(--cream)}
.link-btn-light{display:inline-block;margin-top:28px;padding:13px 36px;border:1px solid var(--gold);color:var(--gold);text-decoration:none;font-size:.62rem;letter-spacing:.26em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn-light:hover{background:var(--gold);color:var(--navy)}

/* ===== RSVP ===== */
.rsvp-section{text-align:center;padding:110px 24px;background:var(--burgundy);position:relative;overflow:hidden}
.rsvp-section::before{content:'';position:absolute;inset:0;background-image:url('/assets/dark-texture.jpg');background-size:cover;background-position:center;opacity:.35}
.rsvp-content{position:relative;z-index:2}
.rsvp-content .eyebrow{font-size:.8rem;letter-spacing:.3em;text-transform:uppercase;color:var(--gold);display:block;margin-bottom:16px}
...
.rsvp-content p{color:rgba(248,240,236,.55);margin-bottom:44px;max-width:400px;margin-left:auto;margin-right:auto;font-size:1rem;line-height:2}
.rsvp-btn{display:inline-block;padding:15px 56px;background:transparent;border:1px solid var(--gold);color:var(--gold);font-size:.65rem;letter-spacing:.28em;text-transform:uppercase;text-decoration:none;font-family:'Jost',sans-serif;transition:background .25s,color .25s}
.rsvp-btn:hover{background:var(--gold);color:var(--navy)}

/* ===== BOTTOM PEONY FOOTER ===== */
footer{background:var(--cream);position:relative;overflow:hidden}
.bottom-floral{width:100%;display:block;height:auto}
.footer-text{padding:56px 24px 56px;text-align:center;position:relative;z-index:2}
footer .names{font-family:'Great Vibes',cursive;font-size:2.8rem;color:var(--navy);margin-bottom:12px}
footer .date{font-size:.6rem;letter-spacing:.3em;text-transform:uppercase;color:var(--rose)}
footer .credit{font-size:1.1rem;font-weight:500;font-weight:500;color:rgba(17,27,46,.18);margin-top:24px}

/* ===== LIGHTBOX ===== */
#lightbox{position:fixed;inset:0;background:rgba(10,14,22,.97);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
...
@media(max-width:600px){
  ...
  .section-dark,.section-rose{padding:64px 24px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#0D1117;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=velvet_peony" style="padding:8px 20px;background:#7D2235;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div style="position:relative;line-height:0;overflow:hidden">
  <img src="/assets/peony-top.jpg" alt="" class="peony-header" onerror="this.style.display='none'">
  <div style="position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;padding:16px 48px;line-height:1.4;text-align:center">
    ...
    <img src="<cfoutput>#HTMLEditFormat(couplePhotoSrc)#</cfoutput>" alt="Couple photo" style="width:80px;height:80px;border-radius:50%;object-fit:cover;border:3px solid var(--burgundy);box-shadow:0 4px 20px rgba(0,0,0,.25);display:block;line-height:0">
    <div style="font-family:'Great Vibes',cursive;font-size:clamp(1.6rem,4vw,3rem);color:var(--burgundy);line-height:1.1">
    ...
    <div style="margin-top:10px;line-height:1">
      <div style="font-family:'Jost',sans-serif;font-size:.6rem;letter-spacing:.3em;text-transform:uppercase;color:var(--burgundy);margin-bottom:6px">We&rsquo;re Getting Married</div>
      <div style="color:var(--burgundy);font-size:.7rem;margin-bottom:6px">&#10022;</div>
      <cfif len(weddingDateFull)>
      <div style="font-family:'Jost',sans-serif;font-size:.6rem;letter-spacing:.2em;text-transform:uppercase;color:var(--burgundy);margin-bottom:4px"><cfoutput>#weddingDateFull#</cfoutput></div>
      </cfif>
      <cfif len(trim(site.venue_name))>
      <div style="font-family:'Jost',sans-serif;font-size:.6rem;letter-spacing:.2em;text-transform:uppercase;color:var(--burgundy);opacity:.8"><cfoutput>#HTMLEditFormat(site.venue_name)#</cfoutput></div>
      </cfif>
    </div>
  </div>
</div>
...
<section class="section" id="our_story">
  <div class="section-title">
    ...
    <h2>Our Story</h2>
    <div class="gold-rule"><div class="line"></div><span class="star">&#10022;</span><div class="line"></div></div>
  </div>
...
<div class="section-dark" id="travel">
  <div class="inner">
    ...
    <p class="text-body-light"><cfoutput>#HTMLEditFormat(site.travel_info)#</cfoutput></p>
    <cfif arrayLen(travelLinks)>
    <div style="display:flex;flex-wrap:wrap;gap:12px;margin-top:24px">
    <cfloop array="#travelLinks#" item="tl">
    <cfoutput><a href="#HTMLEditFormat(tl.url)#" target="_blank" rel="noopener" class="link-btn-light">#len(trim(tl.label)) ? HTMLEditFormat(tl.label) : "View Link"# &rarr;</a></cfoutput>
    </cfloop>
    </div>
    </cfif>
  </div>
...
<div style="line-height:0;overflow:hidden;max-height:520px">
  <img src="/assets/peony-bottom.jpg" alt="" style="width:100%;display:block;height:auto" onerror="this.style.display='none'">
</div>
