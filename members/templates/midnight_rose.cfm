<!---
  midnight_rose.cfm - dark moody floral template
  Palette: near-black #0D0D0D, warm cream #F5EFE6, muted gold #C9A97A, charcoal #1C1C1C
--->
...
<style>
:root{--black:#0D0D0D;--charcoal:#1C1C1C;--cream:#F5EFE6;--gold:#C9A97A;--muted:rgba(245,239,230,.5)}
...
.hero-nav a{color:rgba(245,239,230,.75);text-decoration:none;font-size:.6rem;letter-spacing:.22em;text-transform:uppercase;font-family:'Jost',sans-serif;font-weight:300;padding:10px 16px;border-bottom:1px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap}
...
.hero-date-line{font-size:.65rem;letter-spacing:.3em;text-transform:uppercase;color:rgba(245,239,230,.6);font-family:'Jost',sans-serif}
.hero-dot{width:3px;height:3px;border-radius:50%;background:var(--gold);flex-shrink:0}
.hero-venue-line{font-size:.65rem;letter-spacing:.2em;text-transform:uppercase;color:rgba(245,239,230,.5);font-family:'Jost',sans-serif}
...
.section-wide{padding:80px 0;max-width:1100px;margin:0 auto}
.section-dark{background:var(--charcoal);padding:80px 48px}
.section-dark .inner{max-width:900px;margin:0 auto}

.section-title{margin-bottom:48px}
.section-title .eyebrow{font-size:.58rem;letter-spacing:.35em;text-transform:uppercase;color:var(--gold);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
...
.gold-rule{width:40px;height:1px;background:var(--gold);margin-top:16px;opacity:.6}

/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:2px}
.detail-block{flex:1;min-width:160px;padding:36px 32px;border:1px solid rgba(255,255,255,.07);background:var(--charcoal)}
.detail-block .lbl{font-size:.56rem;letter-spacing:.32em;text-transform:uppercase;color:var(--gold);margin-bottom:12px;display:block;font-family:'Jost',sans-serif}
.detail-block .val{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.5rem;font-weight:300;color:var(--cream);line-height:1.3}
.detail-block .sub{font-size:.78rem;color:var(--muted);margin-top:6px;font-style:italic}

/* ---- STORY ---- */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2;color:rgba(245,239,230,.85);white-space:pre-wrap;font-style:italic;max-width:640px}
...
/* ---- TEXT BLOCKS ---- */
.text-body{font-size:.9rem;color:rgba(245,239,230,.75);line-height:2;white-space:pre-wrap;max-width:620px}
.link-btn{display:inline-block;margin-top:24px;padding:13px 36px;border:1px solid var(--gold);color:var(--gold);text-decoration:none;font-size:.6rem;letter-spacing:.28em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--gold);color:var(--black)}
...
.rsvp-section .eyebrow{font-size:.58rem;letter-spacing:.35em;text-transform:uppercase;color:var(--gold);display:block;margin-bottom:16px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#111;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid #333;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=midnight_rose" style="padding:8px 20px;background:#C9A97A;color:#000;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/dark-roses.jpg" alt="Dark roses" onerror="this.style.display='none'">
    </cfif>
  </div>
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/dark-roses.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
