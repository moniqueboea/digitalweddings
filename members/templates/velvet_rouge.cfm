<!---
  velvet_rouge.cfm - red roses bouquet, full-page fixed background
  Palette: cream #FEFCFB, blush #F5E8E8, rose #B01030, deep #5C1020, muted rgba(92,16,32,.5)
--->
...
<style>
:root{--cream:#FEFCFB;--blush:#F5E8E8;--rose:#B01030;--deep:#5C1020;--muted:rgba(92,16,32,.55)}
...
.page-bg{
  ...
  inset:0;
  z-index:0;
  background-image:url('/assets/velvet-rouge.jpg');
...
.page-bg::after{
  ...
  position:absolute;
  inset:0;
  background:rgba(255,252,251,.42);
}
.page-wrap{
  position:relative;
  z-index:1;
...
nav{
  ...
  border-bottom:1px solid rgba(176,16,48,.15);
  text-align:center;
...
.hero-eyebrow{font-size:.72rem;letter-spacing:.38em;text-transform:uppercase;color:var(--rose);margin-bottom:20px;display:block;font-family:'Jost',sans-serif}
.hero-couple{font-family:'Great Vibes',cursive;font-size:clamp(3.5rem,8vw,7rem);color:var(--deep);line-height:1.1;margin-bottom:32px}
.hero-rule{display:flex;align-items:center;justify-content:center;gap:16px;margin-bottom:24px}
.hero-rule .line{height:1px;width:60px;background:var(--rose);opacity:.4}
.hero-rule .heart{color:var(--rose);font-size:1rem}
.hero-date{font-size:.8rem;letter-spacing:.28em;text-transform:uppercase;color:var(--muted);margin-bottom:8px}
.hero-venue{font-size:.78rem;letter-spacing:.16em;text-transform:uppercase;color:var(--rose);opacity:.8}

/* ---- DIVIDER ---- */
.divider{height:1px;background:rgba(176,16,48,.12);margin:0}

/* ---- SECTIONS ---- */
.section{padding:88px 56px;max-width:860px;margin:0 auto;text-align:center}
.section-tinted{padding:88px 56px;background:rgba(255,252,251,.22);backdrop-filter:blur(3px)}
.section-tinted .inner{max-width:860px;margin:0 auto;text-align:center}

.section-title{margin-bottom:52px}
.section-title .eyebrow{font-size:.75rem;letter-spacing:.28em;text-transform:uppercase;color:var(--rose);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
...
.petal-rule .line{height:1px;width:44px;background:var(--rose);opacity:.35}
.petal-rule .dot{width:5px;height:5px;border-radius:50%;background:var(--rose);opacity:.35}

/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:rgba(176,16,48,.12);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:150px;padding:48px 32px;background:rgba(255,252,251,.32);text-align:center;backdrop-filter:blur(3px)}
...
/* ---- STORY ---- */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2.1;color:var(--deep);white-space:pre-wrap;font-style:italic;max-width:620px;margin:0 auto;opacity:.85}
...
.faq-item{padding:28px 0;border-bottom:1px solid rgba(176,16,48,.12)}
...
/* ---- TEXT ---- */
.text-body{font-size:1rem;color:var(--deep);line-height:2;white-space:pre-wrap;max-width:600px;margin:0 auto;opacity:.8}
.link-btn{display:inline-block;margin-top:28px;padding:13px 36px;border:1px solid var(--rose);color:var(--rose);text-decoration:none;font-size:.72rem;letter-spacing:.22em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--rose);color:var(--cream)}

/* ---- RSVP ---- */
.rsvp-section{position:relative;text-align:center;padding:120px 24px;overflow:hidden}
.rsvp-section .bg{position:absolute;inset:0}
.rsvp-section .bg img{width:100%;height:100%;object-fit:cover;filter:brightness(.22) saturate(.6)}
.rsvp-section .content{position:relative;z-index:2}
.rsvp-section .eyebrow{font-size:.75rem;letter-spacing:.28em;text-transform:uppercase;color:rgba(255,252,251,.7);display:block;margin-bottom:16px}
.rsvp-section .script{font-family:'Great Vibes',cursive;font-size:2.4rem;color:rgba(255,252,251,.9);display:block;margin-bottom:8px}
.rsvp-section h2{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(2.6rem,5vw,4.4rem);font-weight:300;color:#FEFCFB;margin-bottom:16px;letter-spacing:.03em;font-style:italic}
.rsvp-section p{color:rgba(254,252,251,.65);margin-bottom:44px;max-width:400px;margin-left:auto;margin-right:auto;font-size:1rem;line-height:2}
.rsvp-btn{display:inline-block;padding:15px 56px;border:1px solid rgba(254,252,251,.7);color:#FEFCFB;font-size:.72rem;letter-spacing:.28em;text-transform:uppercase;text-decoration:none;font-family:'Jost',sans-serif;transition:background .25s,color .25s}
.rsvp-btn:hover{background:#FEFCFB;color:var(--deep)}

/* ---- FOOTER ---- */
footer{text-align:center;padding:72px 24px;border-top:1px solid rgba(176,16,48,.12);background:rgba(255,252,251,.75);backdrop-filter:blur(10px)}
...
footer .credit{font-size:1.1rem;font-weight:500;font-weight:500;color:rgba(92,16,32,.2);margin-top:24px}

/* ---- LIGHTBOX ---- */
#lightbox{position:fixed;inset:0;background:rgba(92,16,32,.97);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
...
@media(max-width:600px){
  ...
  nav a{font-size:.78rem;padding:14px 10px}
}
</style>
</head>
<body>
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#5C1020;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=velvet_rouge" style="padding:8px 20px;background:#B01030;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div style="text-align:center;padding:18px 24px;border-bottom:1px solid rgba(0,0,0,0.1);font-family:'Jost',sans-serif">
  <span style="font-size:.6rem;letter-spacing:.4em;text-transform:uppercase;color:##B01030">Countdown</span>
  <div style="margin:6px 0;display:flex;align-items:baseline;justify-content:center;gap:8px">
    <span style="font-size:2.4rem;font-weight:700;color:##B01030;line-height:1">#cdDaysUntil#</span>
...
<div style="text-align:center;padding:16px 24px;border-bottom:1px solid rgba(0,0,0,0.1);font-family:'Jost',sans-serif">
  <span style="font-size:.68rem;letter-spacing:.35em;text-transform:uppercase;color:##B01030">Today Is The Day</span>
</div>
</cfif>
</cfoutput>
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/velvet-rouge.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
    <span class="eyebrow">You&rsquo;re Invited</span>
    <span class="script">with love &amp; joy</span>
