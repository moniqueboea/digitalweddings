<!---
  sapphire_rose.cfm - deep blue roses, bordeaux_rose structure
  Palette: near-black #020408, charcoal #080E18, silver #E8EEF4, sapphire #2B5FA8, muted rgba(232,238,244,.5)
--->
...
<style>
:root{--black:##020408;--charcoal:##080E18;--silver:##E8EEF4;--sapphire:##2B5FA8;--muted:#B8C8DC}
*{margin:0;padding:0;box-sizing:border-box}
html{scroll-behavior:smooth}
body{background:var(--black);color:var(--silver);font-family:'Jost',sans-serif;font-weight:300;line-height:1.7;overflow-x:hidden}
...
.hero-overlay{position:absolute;inset:0;background:linear-gradient(to bottom,rgba(2,4,8,.5) 0%,rgba(2,4,8,.15) 40%,rgba(2,4,8,.55) 100%)}
...
.hero-nav a{color:rgba(232,238,244,.7);text-decoration:none;font-size:.75rem;letter-spacing:.18em;text-transform:uppercase;font-family:'Jost',sans-serif;font-weight:300;padding:10px 16px;border-bottom:1px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap}
.hero-nav a:hover,.hero-nav a.active{color:var(--silver);border-bottom-color:var(--silver)}
...
.hero-couple{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(3rem,7vw,6rem);font-weight:300;color:rgba(232,238,244,.6);line-height:1.05;letter-spacing:.01em;text-shadow:0 2px 20px rgba(2,4,8,.9),0 0 40px rgba(2,4,8,.7)}
.hero-meta{margin-top:18px;display:flex;align-items:center;justify-content:center;gap:20px;flex-wrap:wrap}
.hero-date-line{font-size:.8rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(232,238,244,.6);font-family:'Jost',sans-serif}
.hero-dot{width:3px;height:3px;border-radius:50%;background:var(--sapphire);flex-shrink:0}
.hero-venue-line{font-size:.8rem;letter-spacing:.16em;text-transform:uppercase;color:rgba(232,238,244,.5);font-family:'Jost',sans-serif}
...
/* ---- SECTIONS ---- */
.section{padding:80px 48px;max-width:900px;margin:0 auto;background:var(--black)}
.section-dark{background:##0D1828;padding:80px 48px}
.section-dark .inner{max-width:900px;margin:0 auto}

.section-title{margin-bottom:48px}
.section-title .eyebrow{font-size:.75rem;letter-spacing:.25em;text-transform:uppercase;color:var(--sapphire);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
.section-title h2{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(2rem,4vw,3rem);font-weight:300;color:var(--silver);letter-spacing:.03em}
.sapphire-rule{width:40px;height:1px;background:var(--sapphire);margin-top:16px;opacity:.6}

/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:rgba(43,95,168,.2);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:150px;padding:48px 32px;background:var(--charcoal);text-align:center}
.detail-block .lbl{font-size:.75rem;letter-spacing:.22em;text-transform:uppercase;color:var(--sapphire);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
.detail-block .val{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.7rem;font-weight:300;color:var(--silver);line-height:1.25;font-style:italic}
.detail-block .sub{font-size:.78rem;color:var(--muted);margin-top:8px}

/* ---- STORY ---- */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2;color:var(--silver);white-space:pre-wrap;font-style:italic;max-width:640px}
...
.faq-item{padding:24px 0;border-bottom:1px solid rgba(255,255,255,.07)}
.faq-item .q{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.15rem;font-weight:400;color:var(--silver);margin-bottom:8px;font-style:italic}
.faq-item .a{font-size:.95rem;color:var(--muted);line-height:1.9}

/* ---- TEXT BLOCKS ---- */
.text-body{font-size:1rem;color:var(--silver);line-height:2;white-space:pre-wrap;max-width:620px}
.link-btn{display:inline-block;margin-top:24px;padding:13px 36px;border:1px solid var(--sapphire);color:var(--sapphire);text-decoration:none;font-size:.75rem;letter-spacing:.2em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--sapphire);color:var(--silver)}
...
.rsvp-section .bg img{width:100%;height:100%;object-fit:cover;filter:brightness(.18) saturate(.6)}
.rsvp-section .content{position:relative;z-index:2}
.rsvp-section .eyebrow{font-size:.75rem;letter-spacing:.25em;text-transform:uppercase;color:var(--sapphire);display:block;margin-bottom:16px}
.rsvp-section h2{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(2.2rem,5vw,3.8rem);font-weight:300;color:var(--silver);margin-bottom:16px;letter-spacing:.03em}
...
.rsvp-btn{display:inline-block;padding:16px 56px;border:1px solid var(--silver);color:var(--silver);font-size:.65rem;letter-spacing:.3em;text-transform:uppercase;text-decoration:none;font-family:'Jost',sans-serif;transition:background .25s,color .25s}
.rsvp-btn:hover{background:var(--silver);color:var(--black)}

/* ---- FOOTER ---- */
footer{text-align:center;padding:70px 24px;border-top:1px solid rgba(255,255,255,.07)}
footer .names{font-family:'Cormorant Garamond',Georgia,serif;font-size:2.4rem;font-weight:300;color:var(--silver);letter-spacing:.05em;margin-bottom:8px}
...
/* ---- DIVIDER ---- */
.divider{width:100%;height:1px;background:rgba(255,255,255,.06);margin:0}

/* ---- LIGHTBOX ---- */
#lightbox{position:fixed;inset:0;background:rgba(2,4,8,.97);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
#lightbox.show{display:flex}
#lightbox img{max-height:85vh;max-width:90vw;border-radius:2px;object-fit:contain}
#lightbox button{position:absolute;background:rgba(255,255,255,.08);border:none;color:var(--silver);border-radius:0;cursor:pointer;font-family:'Jost',sans-serif}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:##080E18;color:##E8EEF4;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid rgba(43,95,168,.4);gap:12px">
  <cfif isNumeric(url.siteId) AND url.siteId GT 0>
  <span style="opacity:.75">&#128065; Previewing your wedding site</span>
  <button onclick="window.close()" style="padding:8px 20px;background:rgba(255,255,255,.1);color:##E8EEF4;border:none;border-radius:4px;font-weight:600;cursor:pointer;font-size:13px">&times; Close Preview</button>
  <cfelse>
  <span style="opacity:.75">&#128065; Template preview &mdash; sample data shown</span>
  <a href="/members/wedding-site-edit.cfm?template=sapphire_rose" style="padding:8px 20px;background:##2B5FA8;color:##fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/sapphire-rose.jpg" alt="Blue roses" onerror="this.style.display='none'">
    </cfif>
  </div>
...
<div style="text-align:center;padding:18px 24px;border-bottom:1px solid rgba(255,255,255,0.15);font-family:'Jost',sans-serif">
  <span style="font-size:.6rem;letter-spacing:.4em;text-transform:uppercase;color:##E8EEF4">Countdown</span>
  <div style="margin:6px 0;display:flex;align-items:baseline;justify-content:center;gap:8px">
    <span style="font-size:2.4rem;font-weight:700;color:##E8EEF4;line-height:1">#cdDaysUntil#</span>
...
<div style="text-align:center;padding:16px 24px;border-bottom:1px solid rgba(255,255,255,0.15);font-family:'Jost',sans-serif">
  <span style="font-size:.68rem;letter-spacing:.35em;text-transform:uppercase;color:##E8EEF4">Today Is The Day</span>
</div>
</cfif>
</cfoutput>
  ...
  <div class="hero-text">
    ...
    <img src="<cfoutput>#HTMLEditFormat(couplePhotoSrc)#</cfoutput>" alt="Couple photo" style="width:130px;height:130px;border-radius:50%;object-fit:cover;border:3px solid rgba(232,238,244,.5);box-shadow:0 4px 24px rgba(0,0,0,.5);display:block;margin-bottom:22px">
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/sapphire-rose.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
...
<button onclick="window.scrollTo({top:0,behavior:'smooth'})" id="backToTop" aria-label="Back to top" style="display:none;position:fixed;bottom:28px;right:28px;z-index:9000;width:44px;height:44px;border-radius:50%;border:none;cursor:pointer;background:rgba(43,95,168,.8);color:#E8EEF4;font-size:20px;line-height:44px;text-align:center;box-shadow:0 4px 16px rgba(43,95,168,.4);transition:opacity .2s">&uarr;</button>
