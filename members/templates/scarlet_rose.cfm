<!---
  scarlet_rose.cfm - deep red rose & hearts, midnight_peony style
  Palette: near-black #080406, charcoal #120A0E, cream #F5EBE8, crimson #C41E3A
--->
...
<style>
:root{--black:#080406;--charcoal:#120A0E;--cream:#F5EBE8;--crimson:#C41E3A;--muted:rgba(245,235,232,.5)}
...
.hero-overlay{position:absolute;inset:0;background:linear-gradient(to bottom,rgba(0,0,0,.45) 0%,rgba(0,0,0,.2) 40%,rgba(0,0,0,.65) 100%)}
...
.hero-nav a{color:rgba(245,235,232,.75);text-decoration:none;font-size:.75rem;letter-spacing:.18em;text-transform:uppercase;font-family:'Jost',sans-serif;font-weight:300;padding:10px 16px;border-bottom:1px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap}
...
.hero-date-line{font-size:.8rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(245,235,232,.6);font-family:'Jost',sans-serif}
.hero-dot{width:3px;height:3px;border-radius:50%;background:var(--crimson);flex-shrink:0}
.hero-venue-line{font-size:.8rem;letter-spacing:.16em;text-transform:uppercase;color:rgba(245,235,232,.5);font-family:'Jost',sans-serif}
...
.section-title .eyebrow{font-size:.75rem;letter-spacing:.25em;text-transform:uppercase;color:var(--crimson);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
...
.crimson-rule{width:40px;height:1px;background:var(--crimson);margin-top:16px;opacity:.6}

/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:rgba(196,30,58,.2);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:150px;padding:48px 32px;background:var(--charcoal);text-align:center}
.detail-block .lbl{font-size:.75rem;letter-spacing:.22em;text-transform:uppercase;color:var(--crimson);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
...
/* ---- STORY ---- */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2;color:rgba(245,235,232,.85);white-space:pre-wrap;font-style:italic;max-width:640px}
...
/* ---- TEXT BLOCKS ---- */
.text-body{font-size:1rem;color:rgba(245,235,232,.75);line-height:2;white-space:pre-wrap;max-width:620px}
.link-btn{display:inline-block;margin-top:24px;padding:13px 36px;border:1px solid var(--crimson);color:var(--crimson);text-decoration:none;font-size:.75rem;letter-spacing:.2em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--crimson);color:var(--black)}
...
.rsvp-section .bg img{width:100%;height:100%;object-fit:cover;filter:brightness(.25) saturate(.6)}
.rsvp-section .content{position:relative;z-index:2}
.rsvp-section .eyebrow{font-size:.75rem;letter-spacing:.25em;text-transform:uppercase;color:var(--crimson);display:block;margin-bottom:16px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#111;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid #333;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=scarlet_rose" style="padding:8px 20px;background:#C41E3A;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/scarlet-rose.jpg" alt="Red rose" onerror="this.style.display='none'">
    </cfif>
  </div>
...
<div style="text-align:center;padding:18px 24px;border-bottom:1px solid rgba(255,255,255,0.15);font-family:'Jost',sans-serif">
  <span style="font-size:.6rem;letter-spacing:.4em;text-transform:uppercase;color:##C41E3A">Countdown</span>
  <div style="margin:6px 0;display:flex;align-items:baseline;justify-content:center;gap:8px">
    <span style="font-size:2.4rem;font-weight:700;color:##C41E3A;line-height:1">#cdDaysUntil#</span>
...
<div style="text-align:center;padding:16px 24px;border-bottom:1px solid rgba(255,255,255,0.15);font-family:'Jost',sans-serif">
  <span style="font-size:.68rem;letter-spacing:.35em;text-transform:uppercase;color:##C41E3A">Today Is The Day</span>
</div>
</cfif>
</cfoutput>
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/scarlet-rose.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
