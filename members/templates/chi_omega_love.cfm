<!---
  chi_omega_love.cfm — Full-bleed hero image, Chi Omega cardinal red & gold accents
  Palette: dark #1A0000, deep #2A0008, crimson #8B1A1A, red #C41230, gold #C9A84C, gold-light #E8C97A, cream #FAF6EE
--->
...
.hero-overlay{position:absolute;inset:0;background:linear-gradient(to bottom,rgba(26,0,0,.5) 0%,rgba(26,0,0,.2) 40%,rgba(26,0,0,.85) 100%)}

/* Red & gold top border */
.hero-border{position:absolute;top:0;left:0;right:0;height:5px;z-index:5;background:linear-gradient(to right,var(--crimson),var(--gold),var(--gold-light),var(--gold),var(--crimson))}
...
.rsvp-section::before{content:'';position:absolute;top:0;left:0;right:0;height:4px;z-index:2;background:linear-gradient(to right,var(--crimson),var(--gold),var(--gold-light),var(--gold),var(--crimson))}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#1A0000;color:#FAF6EE;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid rgba(201,168,76,.3);gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=chi_omega_love" style="padding:8px 20px;background:#C9A84C;color:#1A0000;border-radius:4px;font-weight:700;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  ...
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/chi-omega-love.png" alt="Chi Omega Love" onerror="this.style.display='none'">
    </cfif>
  </div>
  ...
  <div class="hero-text">
    ...
    <img src="<cfoutput>#HTMLEditFormat(couplePhotoSrc)#</cfoutput>" alt="Couple photo"
      style="width:130px;height:130px;border-radius:50%;object-fit:cover;
             ...
             box-shadow:0 0 0 6px rgba(196,18,48,.2),0 4px 24px rgba(0,0,0,.6);
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/chi-omega-love.png" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
