<!---
  bloom_frame.cfm - red, pink & cream roses framing white center, crimson_frame style
  Palette: deep #150308, rose #A02050, blush #D4708A, cream #FDF5F0
--->
...
<style>
:root{--deep:#150308;--rose:#A02050;--blush:#D4708A;--cream:#FDF5F0;--ivory:#F5E0E8;--muted:rgba(253,245,240,.55)}
...
.page-bg-img{position:absolute;inset:0;background-image:url('/assets/bloom-frame.jpg');background-size:cover;background-position:center center}
.page-bg::after{content:'';position:absolute;inset:0;background:rgba(20,3,8,.55)}
...
/* NAV */
nav{text-align:center;border-bottom:1px solid rgba(253,245,240,.12);background:rgba(20,3,8,.5);backdrop-filter:blur(10px)}
nav a{color:rgba(253,245,240,.7);text-decoration:none;font-size:.75rem;letter-spacing:.18em;text-transform:uppercase;display:inline-block;padding:18px 16px;border-bottom:2px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap;font-family:'Jost',sans-serif;font-weight:300}
nav a:hover,nav a.active{color:var(--cream);border-bottom-color:rgba(253,245,240,.45)}

/* STICKY NAV */
.sticky-nav{position:sticky;top:0;z-index:100;background:rgba(20,3,8,.92);border-bottom:1px solid rgba(160,32,80,.3);display:none;text-align:center;backdrop-filter:blur(10px)}
.sticky-nav a{color:rgba(253,245,240,.65);text-decoration:none;font-size:.75rem;letter-spacing:.18em;text-transform:uppercase;display:inline-block;padding:16px 14px;border-bottom:2px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap;font-family:'Jost',sans-serif;font-weight:300}
.sticky-nav a:hover,.sticky-nav a.active{color:var(--cream);border-bottom-color:var(--blush)}

/* HERO TEXT - centered to sit inside the open frame center */
...
.hero-eyebrow{font-size:.65rem;letter-spacing:.42em;text-transform:uppercase;color:rgba(253,245,240,.55);margin-bottom:20px;display:block;font-family:'Jost',sans-serif}
.hero-couple{font-family:'Great Vibes',cursive;font-size:clamp(3.6rem,9vw,7.5rem);color:var(--cream);line-height:1.08;margin-bottom:28px;text-shadow:0 2px 28px rgba(20,3,8,.7)}
.hero-rule{display:flex;align-items:center;justify-content:center;gap:16px;margin-bottom:20px}
.hero-rule .line{height:1px;width:52px;background:rgba(253,245,240,.3)}
.hero-rule .heart{color:rgba(253,245,240,.5);font-size:.7rem;letter-spacing:.1em}
.hero-date{font-size:.7rem;letter-spacing:.3em;text-transform:uppercase;color:rgba(253,245,240,.5);margin-bottom:6px}
.hero-venue{font-size:.68rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(253,245,240,.35)}

/* ===== CONTENT SECTIONS ===== */
.section{padding:88px 56px;max-width:860px;margin:0 auto;text-align:center}
.section-tinted{padding:88px 56px;background:rgba(20,3,8,.6);backdrop-filter:blur(6px)}
.section-tinted .inner{max-width:860px;margin:0 auto;text-align:center}
.divider{height:1px;background:rgba(160,32,80,.2)}

.section-title{margin-bottom:52px}
.section-title .eyebrow{font-size:.7rem;letter-spacing:.32em;text-transform:uppercase;color:rgba(253,245,240,.4);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
...
.bloom-rule{display:flex;align-items:center;justify-content:center;gap:12px;margin-top:14px}
.bloom-rule .line{height:1px;width:44px;background:var(--blush);opacity:.4}
.bloom-rule .dot{width:4px;height:4px;border-radius:50%;background:var(--blush);opacity:.5}

/* ===== DETAILS ===== */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:rgba(160,32,80,.2);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:150px;padding:48px 32px;background:rgba(20,3,8,.55);backdrop-filter:blur(4px);text-align:center}
.detail-block .lbl{font-size:.62rem;letter-spacing:.32em;text-transform:uppercase;color:rgba(253,245,240,.4);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
...
.detail-block .sub{font-size:.78rem;color:rgba(253,245,240,.4);margin-top:8px}

/* ===== STORY ===== */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2.1;color:rgba(253,245,240,.85);white-space:pre-wrap;font-style:italic;max-width:620px;margin:0 auto}
...
.faq-item{padding:28px 0;border-bottom:1px solid rgba(160,32,80,.18)}
...
.faq-item .a{font-size:.88rem;color:rgba(253,245,240,.5);line-height:1.9}

/* ===== TEXT ===== */
.text-body{font-size:.92rem;color:rgba(253,245,240,.7);line-height:2;white-space:pre-wrap;max-width:600px;margin:0 auto}
.link-btn{display:inline-block;margin-top:28px;padding:13px 36px;border:1px solid rgba(253,245,240,.25);color:var(--cream);text-decoration:none;font-size:.62rem;letter-spacing:.26em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s}
.link-btn:hover{background:rgba(253,245,240,.1)}

/* ===== RSVP ===== */
.rsvp-section{position:relative;text-align:center;padding:140px 24px;overflow:hidden}
.rsvp-bg{position:absolute;inset:0;background-image:url('/assets/bloom-frame.jpg');background-size:cover;background-position:center;z-index:0;filter:brightness(.28) saturate(.8)}
.rsvp-content{position:relative;z-index:2}
.rsvp-content .eyebrow{font-size:.75rem;letter-spacing:.3em;text-transform:uppercase;color:rgba(253,245,240,.45);display:block;margin-bottom:16px}
...
.rsvp-content p{color:rgba(253,245,240,.5);margin-bottom:44px;max-width:400px;margin-left:auto;margin-right:auto;font-size:.95rem;line-height:2}
.rsvp-btn{display:inline-block;padding:15px 56px;border:1px solid rgba(253,245,240,.4);color:var(--cream);font-size:.65rem;letter-spacing:.28em;text-transform:uppercase;text-decoration:none;font-family:'Jost',sans-serif;transition:background .25s,border-color .25s}
.rsvp-btn:hover{background:rgba(253,245,240,.1);border-color:var(--cream)}

/* ===== FOOTER ===== */
footer{text-align:center;padding:72px 24px;border-top:1px solid rgba(160,32,80,.18);background:rgba(20,3,8,.6);backdrop-filter:blur(6px)}
footer .names{font-family:'Great Vibes',cursive;font-size:2.8rem;color:var(--cream);margin-bottom:12px}
footer .date{font-size:.6rem;letter-spacing:.3em;text-transform:uppercase;color:rgba(253,245,240,.32)}
footer .credit{font-size:1.1rem;font-weight:500;font-weight:500;color:rgba(253,245,240,.12);margin-top:24px}

/* ===== LIGHTBOX ===== */
#lightbox{position:fixed;inset:0;background:rgba(20,3,8,.97);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#150308;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=bloom_frame" style="padding:8px 20px;background:#D4708A;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div style="text-align:center;padding:18px 24px;border-bottom:1px solid rgba(255,255,255,0.15);font-family:'Jost',sans-serif">
  <span style="font-size:.6rem;letter-spacing:.4em;text-transform:uppercase;color:##A02050">Countdown</span>
  <div style="margin:6px 0;display:flex;align-items:baseline;justify-content:center;gap:8px">
    <span style="font-size:2.4rem;font-weight:700;color:##A02050;line-height:1">#cdDaysUntil#</span>
...
<div style="text-align:center;padding:16px 24px;border-bottom:1px solid rgba(255,255,255,0.15);font-family:'Jost',sans-serif">
  <span style="font-size:.68rem;letter-spacing:.35em;text-transform:uppercase;color:##A02050">Today Is The Day</span>
</div>
</cfif>
</cfoutput>
...
<section class="section" id="our_story">
  <div class="section-title">
    ...
    <h2>Our Story</h2>
    <div class="bloom-rule"><div class="line"></div><div class="dot"></div><div class="line"></div></div>
  </div>
