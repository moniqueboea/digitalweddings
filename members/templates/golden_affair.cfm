...
<style>
:root{--white:#FEFDFB;--champagne:#F7F0E3;--champ-dark:#EDE0C8;--gold:#C9A242;--deep-gold:#8B6914;--charcoal:#1E1A14;--muted:rgba(30,26,20,.45)}
...
/* NAV */
nav{background:rgba(254,253,251,.97);border-bottom:1px solid var(--champ-dark);backdrop-filter:blur(8px)}
nav .inner{max-width:960px;margin:0 auto;display:flex;align-items:center;justify-content:center;flex-wrap:wrap}
nav a{color:var(--muted);text-decoration:none;font-size:.72rem;letter-spacing:.2em;text-transform:uppercase;padding:18px 16px;border-bottom:2px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap;font-family:'Jost',sans-serif}
nav a:hover,nav a.active{color:var(--deep-gold);border-bottom-color:var(--gold)}

/* sticky nav */
.sticky-nav{position:sticky;top:0;z-index:100;background:rgba(254,253,251,.97);border-bottom:1px solid var(--champ-dark);backdrop-filter:blur(8px);display:none}
.sticky-nav .inner{max-width:960px;margin:0 auto;display:flex;align-items:center;justify-content:center;flex-wrap:wrap}
.sticky-nav a{color:var(--muted);text-decoration:none;font-size:.72rem;letter-spacing:.2em;text-transform:uppercase;padding:16px 16px;border-bottom:2px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap;font-family:'Jost',sans-serif}
.sticky-nav a:hover,.sticky-nav a.active{color:var(--deep-gold);border-bottom-color:var(--gold)}

/* Hero text */
.hero-text{position:relative;z-index:5;padding:64px 24px 48px}
.hero-eyebrow{font-size:.65rem;letter-spacing:.38em;text-transform:uppercase;color:var(--gold);margin-bottom:20px;display:block;font-family:'Jost',sans-serif}
.hero-couple{font-family:'Great Vibes',cursive;font-size:clamp(3.2rem,8vw,6.5rem);color:var(--charcoal);line-height:1.1;margin-bottom:28px}
.hero-rule{display:flex;align-items:center;justify-content:center;gap:16px;margin-bottom:22px}
.hero-rule .line{height:1px;width:60px;background:var(--gold);opacity:.5}
.hero-rule .star{color:var(--gold);font-size:.9rem}
.hero-date{font-size:.7rem;letter-spacing:.3em;text-transform:uppercase;color:var(--muted);margin-bottom:6px}
.hero-venue{font-size:.68rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(154,140,120,.75)}

@media(max-width:600px){
  .hero-couple{font-size:2.8rem}
  .gold-top-right,.gold-bottom-left{width:min(260px,70vw)}
}

/* ---- SECTIONS ---- */
.section{padding:90px 48px;max-width:860px;margin:0 auto;text-align:center}
.section-champ{background:var(--champagne);padding:90px 48px}
.section-champ .inner{max-width:860px;margin:0 auto;text-align:center}
.divider{width:100%;height:1px;background:var(--champ-dark)}

.section-title{margin-bottom:52px}
.section-title .eyebrow{font-size:.72rem;letter-spacing:.32em;text-transform:uppercase;color:var(--gold);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
.section-title h2{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(2.2rem,4vw,3.2rem);font-weight:300;color:var(--charcoal);letter-spacing:.04em;font-style:italic}
.gold-rule{display:flex;align-items:center;justify-content:center;gap:14px;margin-top:16px}
.gold-rule .line{height:1px;width:48px;background:var(--gold);opacity:.4}
.gold-rule .star{color:var(--gold);font-size:.7rem;opacity:.7}

/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:var(--champ-dark);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:160px;padding:48px 36px;background:var(--white);text-align:center}
.detail-block .lbl{font-size:.62rem;letter-spacing:.32em;text-transform:uppercase;color:var(--gold);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
.detail-block .val{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.7rem;font-weight:300;color:var(--charcoal);line-height:1.25;font-style:italic}
.detail-block .sub{font-size:.78rem;color:var(--muted);margin-top:8px}

/* ---- STORY ---- */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2.1;color:var(--charcoal);white-space:pre-wrap;font-style:italic;max-width:620px;margin:0 auto;text-align:center}

/* ---- GALLERY ---- */
.gallery-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(230px,1fr));gap:4px;max-width:860px;margin:0 auto;text-align:left}
...
/* ---- FAQ ---- */
.faq-list{display:flex;flex-direction:column;max-width:660px;margin:0 auto;text-align:left}
.faq-item{padding:28px 0;border-bottom:1px solid var(--champ-dark)}
.faq-item .q{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.15rem;font-weight:600;color:var(--charcoal);margin-bottom:8px;font-style:italic}
.faq-item .a{font-size:.88rem;color:var(--muted);line-height:1.9}

/* ---- TEXT ---- */
.text-body{font-size:.92rem;color:var(--charcoal);line-height:2;white-space:pre-wrap;max-width:620px;margin:0 auto;opacity:.8}
.link-btn{display:inline-block;margin-top:28px;padding:13px 36px;border:1px solid var(--gold);color:var(--deep-gold);text-decoration:none;font-size:.62rem;letter-spacing:.26em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--gold);color:var(--white)}

/* ---- RSVP ---- */
.rsvp-section{text-align:center;padding:110px 24px;background:var(--champagne);position:relative;overflow:hidden}
.rsvp-gold-tl{position:absolute;top:0;left:0;width:min(320px,40vw);transform:rotate(180deg) scaleX(-1);opacity:.5;pointer-events:none}
.rsvp-gold-br{position:absolute;bottom:0;right:0;width:min(320px,40vw);transform:scaleX(-1);opacity:.5;pointer-events:none}
...
.rsvp-content h2{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(2.6rem,5vw,4.4rem);font-weight:300;color:var(--charcoal);margin-bottom:16px;letter-spacing:.03em;font-style:italic}
...
.rsvp-btn{display:inline-block;padding:15px 56px;background:var(--gold);color:var(--white);font-size:.65rem;letter-spacing:.28em;text-transform:uppercase;text-decoration:none;font-family:'Jost',sans-serif;transition:background .25s}
.rsvp-btn:hover{background:var(--deep-gold)}

/* ---- FOOTER ---- */
footer{background:var(--white);text-align:center;padding:80px 24px;position:relative;overflow:hidden}
.footer-gold-left{position:absolute;bottom:0;left:0;width:min(340px,45vw);pointer-events:none}
.footer-gold-right{position:absolute;top:0;right:0;width:min(340px,45vw);pointer-events:none;transform:rotate(180deg) scaleX(-1)}
footer .names{font-family:'Great Vibes',cursive;font-size:2.8rem;color:var(--charcoal);margin-bottom:12px;position:relative;z-index:2}
footer .date{font-size:.6rem;letter-spacing:.3em;text-transform:uppercase;color:var(--gold);position:relative;z-index:2}
footer .credit{font-size:1.1rem;font-weight:500;font-weight:500;color:rgba(30,26,20,.18);margin-top:24px;position:relative;z-index:2}

/* ---- LIGHTBOX ---- */
#lightbox{position:fixed;inset:0;background:rgba(30,26,20,.96);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#1E1A14;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=golden_affair" style="padding:8px 20px;background:#C9A242;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<!--- HERO --->
<div class="hero">
  <img src="/assets/gold-corner-top.jpg" alt="" class="gold-top-right" onerror="this.style.display='none'">
  ...
  <div class="hero-text">
    ...
    <img src="<cfoutput>#HTMLEditFormat(couplePhotoSrc)#</cfoutput>" alt="Couple photo" style="width:100px;height:100px;border-radius:50%;object-fit:cover;border:3px solid var(--gold);box-shadow:0 4px 20px rgba(201,162,66,.25);margin:0 auto 22px;display:block">
  ...
  <img src="/assets/gold-corner-bottom.jpg" alt="" class="gold-bottom-left" onerror="this.style.display='none'">
</div>
...
<div class="divider"></div>
<div class="section-champ" id="q_and_a">
  <div class="inner">
    <div class="section-title">
...
<div class="divider"></div>
<div class="section-champ" id="travel">
  <div class="inner">
    <div class="section-title">
...
<!--- FOOTER --->
<footer>
  <img src="/assets/gold-corner-bottom.jpg" alt="" class="footer-gold-left" onerror="this.style.display='none'">
  <img src="/assets/gold-corner-top.jpg" alt="" class="footer-gold-right" onerror="this.style.display='none'">
