<!---
  ivory_wood.cfm — white roses on rustic wood, bordeaux_rose/midnight_peony style
  Palette: near-black #0C0906, charcoal #1A120C, cream #F8F2E8, sand #C8A882
--->
...
<style>
:root{--black:#0C0906;--charcoal:#1A120C;--cream:#F8F2E8;--sand:#C8A882;--muted:rgba(248,242,232,.5)}
...
.hero-img img{width:100%;height:100%;object-fit:contain;object-position:center center;display:block;background:var(--black)}
.hero-overlay{position:absolute;inset:0;background:linear-gradient(to bottom,rgba(0,0,0,.2) 0%,rgba(0,0,0,.05) 40%,rgba(0,0,0,.55) 100%)}
...
.hero-nav a{color:rgba(248,242,232,.75);text-decoration:none;font-size:.75rem;letter-spacing:.18em;text-transform:uppercase;font-family:'Jost',sans-serif;font-weight:300;padding:10px 16px;border-bottom:1px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap}
.hero-nav a:hover,.hero-nav a.active{color:var(--cream);border-bottom-color:var(--cream)}

/* ---- HERO TEXT ---- */
.hero-text{position:relative;z-index:10;margin-top:auto;padding:0 48px 56px}
...
.hero-meta{margin-top:18px;display:flex;align-items:center;gap:20px;flex-wrap:wrap}
.hero-date-line{font-size:.8rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(248,242,232,.6);font-family:'Jost',sans-serif}
.hero-dot{width:3px;height:3px;border-radius:50%;background:var(--sand);flex-shrink:0}
.hero-venue-line{font-size:.8rem;letter-spacing:.16em;text-transform:uppercase;color:rgba(248,242,232,.5);font-family:'Jost',sans-serif}
...
.section-title .eyebrow{font-size:.75rem;letter-spacing:.25em;text-transform:uppercase;color:var(--sand);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
...
.sand-rule{width:40px;height:1px;background:var(--sand);margin-top:16px;opacity:.6}

/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:rgba(200,168,130,.2);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:150px;padding:48px 32px;background:var(--charcoal);text-align:center}
.detail-block .lbl{font-size:.75rem;letter-spacing:.22em;text-transform:uppercase;color:var(--sand);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
...
/* ---- STORY ---- */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2;color:rgba(248,242,232,.85);white-space:pre-wrap;font-style:italic;max-width:640px}
...
/* ---- TEXT ---- */
.text-body{font-size:1rem;color:rgba(248,242,232,.75);line-height:2;white-space:pre-wrap;max-width:620px}
.link-btn{display:inline-block;margin-top:24px;padding:13px 36px;border:1px solid var(--sand);color:var(--sand);text-decoration:none;font-size:.75rem;letter-spacing:.2em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--sand);color:var(--black)}
...
.rsvp-section .bg img{width:100%;height:100%;object-fit:cover;object-position:center top;filter:brightness(.2) saturate(.5)}
.rsvp-section .content{position:relative;z-index:2}
.rsvp-section .eyebrow{font-size:.75rem;letter-spacing:.25em;text-transform:uppercase;color:var(--sand);display:block;margin-bottom:16px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#111;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid #333;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=ivory_wood" style="padding:8px 20px;background:#C8A882;color:#0C0906;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/ivory-wood.jpg" alt="Ivory wood" onerror="this.style.display='none'">
    </cfif>
  </div>
  ...
  <div style="position:absolute;bottom:180px;left:48px;z-index:11"><img src="<cfoutput>#HTMLEditFormat(couplePhotoSrc)#</cfoutput>" alt="Couple photo" style="width:90px;height:90px;border-radius:50%;object-fit:cover;border:3px solid rgba(255,255,255,.5);box-shadow:0 2px 16px rgba(0,0,0,.4);display:block"></div>
  <div class="hero-text">
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/ivory-wood.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
