<!---
  blushing_rose.cfm - soft blush/white roses with bokeh, copper_rose/bordeaux_rose style
  Palette: near-black #060405, charcoal #100608, cream #FBF3F0, blush #D4899A
--->
...
<style>
:root{--black:#060405;--charcoal:#100608;--cream:#FBF3F0;--blush:#D4899A;--muted:rgba(251,243,240,.5)}
...
.hero-nav a{color:rgba(251,243,240,.75);text-decoration:none;font-size:.75rem;letter-spacing:.18em;text-transform:uppercase;font-family:'Jost',sans-serif;font-weight:300;padding:10px 16px;border-bottom:1px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap}
...
.hero-date-line{font-size:.8rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(251,243,240,.6);font-family:'Jost',sans-serif}
.hero-dot{width:3px;height:3px;border-radius:50%;background:var(--blush);flex-shrink:0}
.hero-venue-line{font-size:.8rem;letter-spacing:.16em;text-transform:uppercase;color:rgba(251,243,240,.5);font-family:'Jost',sans-serif}
...
/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:rgba(212,137,154,.2);max-width:860px;margin:0 auto}
...
/* ---- STORY ---- */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2;color:rgba(251,243,240,.85);white-space:pre-wrap;font-style:italic;max-width:640px}
...
/* ---- TEXT ---- */
.text-body{font-size:1rem;color:rgba(251,243,240,.75);line-height:2;white-space:pre-wrap;max-width:620px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#111;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid #333;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=blushing_rose" style="padding:8px 20px;background:#D4899A;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/blushing-rose.jpg" alt="Blushing roses" onerror="this.style.display='none'">
    </cfif>
  </div>
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/blushing-rose.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
