<!---
  indigo_bloom.cfm - navy watercolor floral side borders, white & gold
  Palette: white #FEFEFE, ice #EEF3F9, navy #1C3166, blue #4A6FA5, gold #B8922A, muted rgba(28,49,102,.45)
--->
...
<style>
:root{--white:#FEFEFE;--ice:#EEF3F9;--ice-dark:#D6E1EF;--navy:#1C3166;--blue:#4A6FA5;--gold:#B8922A;--deep-gold:#8A6918;--muted:rgba(28,49,102,.42)}
*{margin:0;padding:0;box-sizing:border-box}
html{scroll-behavior:smooth}
body{background:var(--white);color:var(--navy);font-family:'Jost',sans-serif;font-weight:300;line-height:1.7;overflow-x:hidden}

/* ---- SIDE FLORALS ---- */
/* These run the full height of the page, fixed to left and right edges */
.floral-left,
.floral-right{position:fixed;top:0;bottom:0;width:clamp(80px,8vw,140px);pointer-events:none;z-index:50;overflow:hidden}
.floral-left{left:0}
.floral-right{right:0}
.floral-left img,
.floral-right img{width:100%;height:100%;object-fit:cover;object-position:center top;display:block}

/* ---- PAGE WRAPPER - inset from side florals ---- */
.page{margin:0 clamp(80px,8vw,140px)}

/* ---- HERO ---- */
.hero{background:var(--white);text-align:center;padding:72px 24px 80px;position:relative;height:70vh;min-height:520px}

/* NAV */
nav{background:var(--white);border-bottom:1px solid var(--ice-dark);text-align:center}
...
/* Sticky nav */
.sticky-nav{position:sticky;top:0;z-index:40;background:rgba(254,254,254,.97);border-bottom:1px solid var(--ice-dark);display:none;text-align:center;backdrop-filter:blur(8px)}
.sticky-nav a{color:var(--muted);text-decoration:none;font-size:.88rem;letter-spacing:.14em;text-transform:uppercase;display:inline-block;padding:17px 16px;border-bottom:2px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap;font-family:'Jost',sans-serif}
.sticky-nav a:hover,.sticky-nav a.active{color:var(--navy);border-bottom-color:var(--gold)}

/* Hero text */
.hero-eyebrow{font-size:.65rem;letter-spacing:.38em;text-transform:uppercase;color:var(--blue);margin-bottom:24px;display:block;font-family:'Jost',sans-serif}
.hero-couple{font-family:'Great Vibes',cursive;font-size:clamp(3rem,7vw,6rem);color:var(--navy);line-height:1.1;margin-bottom:28px}
.hero-rule{display:flex;align-items:center;justify-content:center;gap:16px;margin-bottom:22px}
.hero-rule .line{height:1px;width:56px;background:var(--gold);opacity:.5}
...
.hero-venue{font-size:.68rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(74,111,165,.6)}

/* ---- SECTIONS ---- */
.section{padding:88px 56px;max-width:840px;margin:0 auto;text-align:center}
.section-ice{background:var(--ice);padding:88px 56px}
.section-ice .inner{max-width:840px;margin:0 auto;text-align:center}
.divider{height:1px;background:var(--ice-dark)}
...
.navy-rule{display:flex;align-items:center;justify-content:center;gap:14px;margin-top:16px}
.navy-rule .line{height:1px;width:44px;background:var(--navy);opacity:.2}
.navy-rule .dot{width:4px;height:4px;border-radius:50%;background:var(--gold);opacity:.7}

/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:var(--ice-dark);max-width:840px;margin:0 auto}
...
/* ---- STORY ---- */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2.1;color:var(--navy);white-space:pre-wrap;font-style:italic;max-width:600px;margin:0 auto}

/* ---- GALLERY ---- */
.gallery-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(210px,1fr));gap:4px;max-width:840px;margin:0 auto;text-align:left}
.g-photo{aspect-ratio:1;overflow:hidden;cursor:pointer;border-radius:10px}
.g-photo img{width:100%;height:100%;object-fit:cover;transition:transform .5s,filter .3s;filter:saturate(.88)}
...
.faq-item{padding:28px 0;border-bottom:1px solid var(--ice-dark)}
.faq-item .q{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.15rem;font-weight:600;color:var(--navy);margin-bottom:8px;font-style:italic}
.faq-item .a{font-size:.88rem;color:var(--muted);line-height:1.9}

/* ---- TEXT ---- */
.text-body{font-size:.92rem;color:var(--navy);line-height:2;white-space:pre-wrap;max-width:580px;margin:0 auto;opacity:.75}
.link-btn{display:inline-block;margin-top:28px;padding:13px 36px;border:1px solid var(--navy);color:var(--navy);text-decoration:none;font-size:.62rem;letter-spacing:.26em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--navy);color:var(--white)}

/* ---- RSVP ---- */
.rsvp-section{text-align:center;padding:110px 24px;background:var(--navy);position:relative}
...
.rsvp-content h2{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(2.6rem,5vw,4.4rem);font-weight:300;color:var(--white);margin-bottom:16px;letter-spacing:.03em;font-style:italic}
.rsvp-content p{color:rgba(255,255,255,.55);margin-bottom:44px;max-width:400px;margin-left:auto;margin-right:auto;font-size:1rem;line-height:2}
...
/* ---- FOOTER ---- */
footer{background:var(--white);text-align:center;padding:72px 24px;border-top:1px solid var(--ice-dark)}
...
footer .credit{font-size:1.1rem;font-weight:500;font-weight:500;color:rgba(28,49,102,.18);margin-top:24px}

/* ---- LIGHTBOX ---- */
#lightbox{position:fixed;inset:0;background:rgba(28,49,102,.96);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
...
/* Hide side borders on very small screens */
@media(max-width:540px){
  .floral-left,.floral-right{display:none}
  .page{margin:0}
}
</style>
</head>
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#1C3166;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=indigo_bloom" style="padding:8px 20px;background:#B8922A;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
<div style="height:48px"></div>
</cfif>

<!--- Fixed side floral borders --->
<div class="floral-left">
  <img src="/assets/blue-floral-left.jpg" alt="" onerror="this.style.display='none'">
</div>
<div class="floral-right">
  <img src="/assets/blue-floral-right.jpg" alt="" onerror="this.style.display='none'">
</div>

<!--- All page content inset from the side borders --->
<div class="page">
...
<div style="text-align:center;padding:18px 24px;border-bottom:1px solid rgba(0,0,0,0.1);font-family:'Jost',sans-serif">
  <span style="font-size:.6rem;letter-spacing:.4em;text-transform:uppercase;color:##EEF3F9">Countdown</span>
  <div style="margin:6px 0;display:flex;align-items:baseline;justify-content:center;gap:8px">
    <span style="font-size:2.4rem;font-weight:700;color:##EEF3F9;line-height:1">#cdDaysUntil#</span>
...
<div style="text-align:center;padding:16px 24px;border-bottom:1px solid rgba(0,0,0,0.1);font-family:'Jost',sans-serif">
  <span style="font-size:.68rem;letter-spacing:.35em;text-transform:uppercase;color:##EEF3F9">Today Is The Day</span>
</div>
</cfif>
</cfoutput>
    ...
    <div class="hero">
      ...
      <img src="<cfoutput>#HTMLEditFormat(couplePhotoSrc)#</cfoutput>" alt="Couple photo" style="width:110px;height:110px;border-radius:50%;object-fit:cover;border:3px solid rgba(255,255,255,.5);box-shadow:0 4px 20px rgba(0,0,0,.3);display:block;margin:0 auto 20px">
  ...
  <section class="section" id="our_story">
    <div class="section-title">
      ...
      <h2>Our Story</h2>
      <div class="navy-rule"><div class="line"></div><div class="dot"></div><div class="line"></div></div>
    </div>
  ...
  <section id="details" style="padding:88px 0">
    <div style="max-width:840px;margin:0 auto;padding:0 56px 52px;text-align:center">
      <div class="section-title">
  ...
  <div class="divider"></div>
  <div class="section-ice" id="q_and_a">
    <div class="inner">
      <div class="section-title">
  ...
  <div class="divider"></div>
  <div class="section-ice" id="travel">
    <div class="inner">
      <div class="section-title">
