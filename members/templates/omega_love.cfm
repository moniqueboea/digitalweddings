<!---
  omega_love.cfm — Full-bleed hero image, Omega Psi Phi purple & gold accents
  Palette: black #0A0010, deep #110020, purple #4B0082, royal #6A0DAD, gold #C9A84C, cream #FAF6EE
--->
...
body{background:var(--black);color:var(--cream);font-family:'Cinzel',serif;font-weight:400;line-height:1.7;overflow-x:hidden}

/* ---- HERO ---- */
.hero{position:relative;height:85vh;min-height:600px;overflow:hidden;display:flex;flex-direction:column}
.hero-img{position:absolute;inset:0;background:var(--black);display:flex;align-items:flex-start;justify-content:center}
.hero-img img{width:auto;height:100%;max-width:100%;object-fit:contain;object-position:center top;display:block}
.hero-overlay{position:absolute;inset:0;background:linear-gradient(to bottom,rgba(10,0,16,.5) 0%,rgba(10,0,16,.2) 40%,rgba(10,0,16,.8) 100%)}
...
.hero-nav{position:absolute;bottom:460px;left:0;right:0;z-index:10;display:flex;align-items:center;justify-content:center;flex-wrap:wrap;gap:0;padding:0 24px}
...
.rsvp-btn:hover{background:var(--gold);color:var(--black)}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#0A0010;color:#FAF6EE;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid rgba(201,168,76,.3);gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=omega_love" style="padding:8px 20px;background:#C9A84C;color:#0A0010;border-radius:4px;font-weight:700;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  ...
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/omega-love.jpg" alt="Omega Love" onerror="this.style.display='none'">
    </cfif>
  </div>
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/omega-love.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
