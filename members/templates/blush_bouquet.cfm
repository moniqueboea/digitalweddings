<!---
  blush_bouquet.cfm - watercolor peach & blush roses with ribbon bow, flush right
  Palette: cream #FEFAF8, blush #F7EDE8, peach #D4907A, rose #A85868, deep #5C2535
--->
...
<style>
:root{--cream:#FEFAF8;--blush:#F7EDE8;--blush-dark:#E0C8C0;--peach:#D4907A;--rose:#A85868;--deep:#5C2535;--muted:rgba(92,37,53,.45)}
...
nav a:hover,nav a.active{color:var(--deep);border-bottom-color:var(--peach)}

.sticky-nav{position:sticky;top:0;z-index:100;background:rgba(254,250,248,.97);border-bottom:1px solid var(--blush-dark);display:none;text-align:center;backdrop-filter:blur(8px)}
...
.sticky-nav a:hover,.sticky-nav a.active{color:var(--deep);border-bottom-color:var(--peach)}

/* ===== HERO ===== */
.hero{position:relative;background:var(--cream);height:70vh;min-height:520px;display:flex;align-items:center;overflow:hidden}

/* Watercolor bouquet flush right */
.hero-floral{position:absolute;top:0;right:0;height:100%;width:auto;display:block;pointer-events:none;z-index:2}

/* Hero text - left side */
.hero-text{position:relative;z-index:5;width:55%;padding:48px 24px 48px 56px;text-align:center}
.hero-eyebrow{font-size:.68rem;letter-spacing:.38em;text-transform:uppercase;color:var(--peach);margin-bottom:24px;display:block;font-family:'Jost',sans-serif}
...
.hero-rule .line{height:1px;width:56px;background:var(--peach);opacity:.5}
.hero-rule .heart{color:var(--peach);font-size:.9rem}
.hero-date{font-size:.72rem;letter-spacing:.3em;text-transform:uppercase;color:var(--muted);margin-bottom:6px}
.hero-venue{font-size:.7rem;letter-spacing:.18em;text-transform:uppercase;color:var(--peach);opacity:.8}

@media(max-width:700px){
  .hero{align-items:flex-end}
  .hero-floral{height:70%;top:auto;bottom:0;opacity:.3}
  .hero-text{width:100%;padding:32px 24px 40px;background:rgba(254,250,248,.9)}
}
...
.section-title .eyebrow{font-size:.72rem;letter-spacing:.32em;text-transform:uppercase;color:var(--peach);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
...
.petal-rule .line{height:1px;width:44px;background:var(--peach);opacity:.4}
.petal-rule .dot{width:5px;height:5px;border-radius:50%;background:var(--rose);opacity:.4}
...
.detail-block .lbl{font-size:.62rem;letter-spacing:.32em;text-transform:uppercase;color:var(--peach);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
...
.link-btn{display:inline-block;margin-top:28px;padding:13px 36px;border:1px solid var(--peach);color:var(--rose);text-decoration:none;font-size:.62rem;letter-spacing:.26em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--peach);color:var(--cream)}

/* ===== RSVP ===== */
.rsvp-section{position:relative;text-align:center;padding:110px 24px;background:var(--blush);overflow:hidden}
.rsvp-floral{position:absolute;bottom:0;right:0;height:90%;width:auto;opacity:.15;pointer-events:none}
.rsvp-content{position:relative;z-index:2}
.rsvp-content .eyebrow{font-size:.8rem;letter-spacing:.3em;text-transform:uppercase;color:var(--peach);display:block;margin-bottom:16px}
...
.rsvp-btn{display:inline-block;padding:15px 56px;background:var(--rose);color:var(--cream);font-size:.65rem;letter-spacing:.28em;text-transform:uppercase;text-decoration:none;font-family:'Jost',sans-serif;transition:background .25s}
...
footer .date{font-size:.6rem;letter-spacing:.3em;text-transform:uppercase;color:var(--peach)}
footer .credit{font-size:1.1rem;font-weight:500;font-weight:500;color:rgba(92,37,53,.18);margin-top:24px}

/* ===== LIGHTBOX ===== */
#lightbox{position:fixed;inset:0;background:rgba(92,37,53,.97);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#5C2535;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=blush_bouquet" style="padding:8px 20px;background:#A85868;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div style="text-align:center;padding:18px 24px;border-bottom:1px solid rgba(0,0,0,0.1);font-family:'Jost',sans-serif">
  <span style="font-size:.6rem;letter-spacing:.4em;text-transform:uppercase;color:##D4907A">Countdown</span>
  <div style="margin:6px 0;display:flex;align-items:baseline;justify-content:center;gap:8px">
    <span style="font-size:2.4rem;font-weight:700;color:##D4907A;line-height:1">#cdDaysUntil#</span>
...
<div style="text-align:center;padding:16px 24px;border-bottom:1px solid rgba(0,0,0,0.1);font-family:'Jost',sans-serif">
  <span style="font-size:.68rem;letter-spacing:.35em;text-transform:uppercase;color:##D4907A">Today Is The Day</span>
</div>
</cfif>
</cfoutput>
...
<div class="hero" id="hero">
  <img src="/assets/blush-bouquet.jpg" alt="" class="hero-floral" onerror="this.style.display='none'">
  <div class="hero-text">
...
<section class="rsvp-section" id="rsvp">
  <img src="/assets/blush-bouquet.jpg" alt="" class="rsvp-floral" onerror="this.style.display='none'">
