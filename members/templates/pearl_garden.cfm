<!---
  pearl_garden.cfm — blush watercolor peonies with silver-gray leaves
  Top: gray leaf sweep + pink bud, flush right | Bottom: blush peony cluster, flush left
  Palette: white #FEFEFE, blush #F5E8E4, rose #C4909A, mauve #9C7A82, deep #3D2C30
--->
...
<style>
:root{--white:#FEFEFE;--blush:#F5E8E4;--blush-dark:#E8D0CA;--rose:#C4909A;--mauve:#9C7A82;--deep:#3D2C30;--muted:rgba(61,44,48,.42)}
*{margin:0;padding:0;box-sizing:border-box}
html{scroll-behavior:smooth}
body{background:var(--white);color:var(--deep);font-family:'Jost',sans-serif;font-weight:300;line-height:1.7;overflow-x:hidden}

/* ===== TOP FLORAL ===== */
.floral-top{display:block;width:100%;height:auto;max-height:clamp(180px,32vh,340px);object-fit:cover;object-position:right top}

/* ===== NAV ===== */
nav{background:var(--white);border-bottom:1px solid var(--blush-dark);text-align:center;position:relative;z-index:20}
...
.sticky-nav{position:sticky;top:0;z-index:100;background:rgba(254,254,254,.97);border-bottom:1px solid var(--blush-dark);display:none;text-align:center;backdrop-filter:blur(8px)}
...
.sticky-nav a:hover,.sticky-nav a.active{color:var(--rose);border-bottom-color:var(--rose)}

/* ===== HERO ===== */
.hero{position:relative;background:var(--white);height:70vh;min-height:520px;display:flex;align-items:center;justify-content:center;overflow:hidden}
.hero-text{position:relative;z-index:5;text-align:center;padding:40px 24px}
...
.hero-couple{font-family:'Great Vibes',cursive;font-size:clamp(3.2rem,7vw,6.5rem);color:var(--deep);line-height:1.1;margin-bottom:28px}
.hero-rule{display:flex;align-items:center;justify-content:center;gap:16px;margin-bottom:22px}
.hero-rule .line{height:1px;width:56px;background:var(--rose);opacity:.4}
...
.hero-venue{font-size:.7rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(196,144,154,.7)}
...
.petal-rule .dot{width:5px;height:5px;border-radius:50%;background:var(--mauve);opacity:.5}
...
.link-btn{display:inline-block;margin-top:28px;padding:13px 36px;border:1px solid var(--rose);color:var(--mauve);text-decoration:none;font-size:.62rem;letter-spacing:.26em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--rose);color:var(--white)}

/* ===== RSVP ===== */
.rsvp-section{text-align:center;padding:110px 24px;background:var(--blush)}
...
.rsvp-btn{display:inline-block;padding:15px 56px;background:var(--mauve);color:var(--white);font-size:.65rem;letter-spacing:.28em;text-transform:uppercase;text-decoration:none;font-family:'Jost',sans-serif;transition:background .25s}
.rsvp-btn:hover{background:var(--deep)}

/* ===== FOOTER ===== */
footer{background:var(--white);text-align:center;padding:72px 24px;border-top:1px solid var(--blush-dark)}
...
footer .credit{font-size:1.1rem;font-weight:500;font-weight:500;color:rgba(61,44,48,.18);margin-top:24px}

/* ===== LIGHTBOX ===== */
#lightbox{position:fixed;inset:0;background:rgba(61,44,48,.96);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#3D2C30;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=pearl_garden" style="padding:8px 20px;background:#C4909A;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
<div style="height:48px"></div>
</cfif>

<!--- TOP FLORAL: flush right --->
<div style="line-height:0;overflow:hidden;text-align:right">
  <img src="/assets/pearl-top.jpg" alt="" class="floral-top" onerror="this.style.display='none'">
</div>
...
<!--- BOTTOM FLORAL: flush left --->
<div style="line-height:0;overflow:hidden;text-align:left">
  <img src="/assets/pearl-bottom.jpg" alt="" style="display:inline-block;width:100%;height:auto;max-height:clamp(200px,36vh,400px);object-fit:cover;object-position:left top" onerror="this.style.display='none'">
</div>
