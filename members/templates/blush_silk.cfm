...
.hero-eyebrow{font-size:.68rem;letter-spacing:.38em;text-transform:uppercase;color:var(--rose);margin-bottom:24px;display:block;font-family:'Jost',sans-serif}
.hero-couple{font-family:'Great Vibes',cursive;font-size:clamp(3.4rem,8vw,7rem);color:var(--wine);line-height:1.1;margin-bottom:28px}
...
.hero-venue{font-size:.7rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(196,144,144,.8)}
...
/* ===== TEXT ===== */
.text-body{font-size:.92rem;color:var(--wine);line-height:2;white-space:pre-wrap;max-width:600px;margin:0 auto;opacity:.75}
...
.rsvp-content .eyebrow{font-size:.8rem;letter-spacing:.3em;text-transform:uppercase;color:var(--rose);display:block;margin-bottom:16px}
