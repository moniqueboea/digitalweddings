<!---
  rose_garden.cfm - bright airy scattered roses on blush pink
  Palette: white #FFFFFF, blush #FFF0F3, rose #D63670, deep-rose #9C1C4A, petal #F9D0DF
--->
...
<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;1,300;1,400&family=Jost:wght@200;300;400&family=Great+Vibes&display=swap" rel="stylesheet">
<style>
:root{--white:#FFFFFF;--blush:#FFF0F3;--petal:#F9D0DF;--rose:#D63670;--deep:#9C1C4A;--text:#3A1525;--muted:#A0687E}
*{margin:0;padding:0;box-sizing:border-box}
html{scroll-behavior:smooth}
body{background:var(--white);color:var(--text);font-family:'Jost',sans-serif;font-weight:300;line-height:1.7;overflow-x:hidden}

/* ---- HERO ---- */
.hero{position:relative;height:45vh;min-height:420px;overflow:hidden;display:flex;flex-direction:column}
.hero-img{position:absolute;inset:0}
.hero-img img{width:100%;height:100%;object-fit:cover;object-position:center;display:block}
.hero-overlay{position:absolute;inset:0;background:linear-gradient(to bottom,rgba(255,240,243,.15) 0%,rgba(255,240,243,.05) 40%,rgba(156,28,74,.45) 100%)}

/* ---- NAV overlaid on hero ---- */
.hero-nav{position:absolute;top:0;left:0;right:0;z-index:10;display:flex;align-items:center;justify-content:center;flex-wrap:wrap;gap:0;padding:0 24px;background:rgba(255,255,255,.18);backdrop-filter:blur(10px);border-bottom:1px solid rgba(255,255,255,.2)}
.hero-nav a{color:rgba(58,21,37,.75);text-decoration:none;font-size:.75rem;letter-spacing:.18em;text-transform:uppercase;font-family:'Jost',sans-serif;font-weight:400;padding:10px 16px;border-bottom:1px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap}
.hero-nav a:hover,.hero-nav a.active{color:var(--deep);border-bottom-color:var(--deep)}

/* ---- HERO TEXT ---- */
.hero-text{position:relative;z-index:10;margin:auto;padding:48px;display:flex;flex-direction:column;align-items:center;text-align:center}
.hero-script{font-family:'Great Vibes',cursive;font-size:clamp(1rem,2.5vw,1.6rem);color:rgba(255,255,255,.9);letter-spacing:.05em;display:block;margin-bottom:4px}
.hero-couple{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(3rem,7vw,6rem);font-weight:300;color:#FFFFFF;line-height:1.05;letter-spacing:.01em}
.hero-meta{margin-top:18px;display:flex;align-items:center;justify-content:center;gap:20px;flex-wrap:wrap}
.hero-date-line{font-size:.8rem;letter-spacing:.22em;text-transform:uppercase;color:rgba(255,255,255,.8);font-family:'Jost',sans-serif}
.hero-dot{width:3px;height:3px;border-radius:50%;background:rgba(255,255,255,.6);flex-shrink:0}
.hero-venue-line{font-size:.8rem;letter-spacing:.16em;text-transform:uppercase;color:rgba(255,255,255,.7);font-family:'Jost',sans-serif}
...
/* ---- DIVIDER ---- */
.divider{width:100%;height:1px;background:var(--petal);margin:0}

/* ---- SECTIONS ---- */
.section{padding:80px 48px;max-width:900px;margin:0 auto}
.section-blush{background:var(--blush);padding:80px 48px}
.section-blush .inner{max-width:900px;margin:0 auto}

.section-title{margin-bottom:48px}
.section-title .eyebrow{font-size:.75rem;letter-spacing:.25em;text-transform:uppercase;color:var(--rose);display:block;margin-bottom:10px;font-family:'Jost',sans-serif}
.section-title h2{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(2rem,4vw,3rem);font-weight:300;color:var(--deep);letter-spacing:.03em}
.section-title .script-sub{font-family:'Great Vibes',cursive;font-size:1.6rem;color:var(--rose);display:block;margin-top:4px}
.petal-rule{width:40px;height:2px;background:linear-gradient(to right,var(--rose),var(--petal));margin-top:16px;border-radius:1px}

/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:var(--petal);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:150px;padding:48px 32px;background:var(--white);text-align:center}
.detail-block .lbl{font-size:.72rem;letter-spacing:.28em;text-transform:uppercase;color:var(--rose);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
...
/* ---- STORY ---- */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2;color:var(--text);white-space:pre-wrap;font-style:italic;max-width:640px}
...
.g-photo img{width:100%;height:100%;object-fit:cover;transition:transform .5s,filter .4s;filter:saturate(.9)}
.g-photo:hover img{transform:scale(1.05);filter:saturate(1.1)}

/* ---- FAQ ---- */
.faq-list{display:flex;flex-direction:column;max-width:680px}
.faq-item{padding:24px 0;border-bottom:1px solid var(--petal)}
.faq-item .q{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.15rem;font-weight:400;color:var(--deep);margin-bottom:8px;font-style:italic}
.faq-item .a{font-size:.95rem;color:var(--muted);line-height:1.9}

/* ---- TEXT BLOCKS ---- */
.text-body{font-size:1rem;color:var(--muted);line-height:2;white-space:pre-wrap;max-width:620px}
.link-btn{display:inline-block;margin-top:24px;padding:13px 36px;border:1px solid var(--rose);color:var(--rose);text-decoration:none;font-size:.75rem;letter-spacing:.2em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--rose);color:var(--white)}

/* ---- RSVP ---- */
.rsvp-section{text-align:center;padding:120px 24px;position:relative;overflow:hidden;background:var(--blush)}
.rsvp-section .bg{position:absolute;inset:0}
.rsvp-section .bg img{width:100%;height:100%;object-fit:cover;filter:brightness(.18) saturate(.5)}
.rsvp-section .content{position:relative;z-index:2}
.rsvp-section .eyebrow{font-size:.75rem;letter-spacing:.25em;text-transform:uppercase;color:rgba(255,255,255,.8);display:block;margin-bottom:12px}
.rsvp-section .script{font-family:'Great Vibes',cursive;font-size:2.2rem;color:rgba(255,255,255,.9);display:block;margin-bottom:8px}
.rsvp-section h2{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(2.2rem,5vw,3.8rem);font-weight:300;color:#FFFFFF;margin-bottom:16px;letter-spacing:.03em}
.rsvp-section p{color:rgba(255,255,255,.7);margin-bottom:44px;max-width:420px;margin-left:auto;margin-right:auto;font-size:.9rem;line-height:1.9}
.rsvp-btn{display:inline-block;padding:16px 56px;border:1px solid rgba(255,255,255,.8);color:#FFFFFF;font-size:.65rem;letter-spacing:.3em;text-transform:uppercase;text-decoration:none;font-family:'Jost',sans-serif;transition:background .25s,color .25s}
.rsvp-btn:hover{background:#FFFFFF;color:var(--deep)}

/* ---- FOOTER ---- */
footer{text-align:center;padding:70px 24px;border-top:1px solid var(--petal);background:var(--white)}
footer .script{font-family:'Great Vibes',cursive;font-size:1.6rem;color:var(--rose);display:block;margin-bottom:6px}
footer .names{font-family:'Cormorant Garamond',Georgia,serif;font-size:2.2rem;font-weight:300;color:var(--deep);letter-spacing:.05em;margin-bottom:8px}
footer .date{font-size:.6rem;letter-spacing:.28em;text-transform:uppercase;color:var(--muted)}
footer .credit{font-size:1.1rem;font-weight:500;font-weight:500;color:var(--petal);margin-top:28px}

/* ---- LIGHTBOX ---- */
#lightbox{position:fixed;inset:0;background:rgba(58,21,37,.97);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
#lightbox.show{display:flex}
#lightbox img{max-height:85vh;max-width:90vw;object-fit:contain}
#lightbox button{position:absolute;background:rgba(255,255,255,.1);border:none;color:#fff;cursor:pointer;font-family:'Jost',sans-serif}
...
#lightbox .count{position:absolute;bottom:20px;color:rgba(255,255,255,.4);font-size:.75rem;letter-spacing:.1em}
</style>
</head>
<body>

<cfif structKeyExists(site,"is_preview") AND site.is_preview>
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#fff0f3;color:#9C1C4A;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;border-bottom:1px solid #F9D0DF;gap:12px">
  <cfif isNumeric(url.siteId) AND url.siteId GT 0>
  <span style="opacity:.8">&#128065; Previewing your wedding site</span>
  <button onclick="window.close()" style="padding:8px 20px;background:#9C1C4A;color:#fff;border:none;border-radius:4px;font-weight:600;cursor:pointer;font-size:13px">&times; Close Preview</button>
  <cfelse>
  <span style="opacity:.8">&#128065; Template preview &mdash; sample data shown</span>
  <a href="/members/wedding-site-edit.cfm?template=rose_garden" style="padding:8px 20px;background:#D63670;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div class="hero">
  <div class="hero-img">
    ...
    <cfelse>
    <img src="/assets/rose-scatter.jpg" alt="Pink roses" onerror="this.style.background='#FFF0F3'">
    </cfif>
  </div>
...
<div style="text-align:center;padding:18px 24px;border-bottom:1px solid rgba(0,0,0,0.1);font-family:'Jost',sans-serif">
  <span style="font-size:.6rem;letter-spacing:.4em;text-transform:uppercase;color:##D63670">Countdown</span>
  <div style="margin:6px 0;display:flex;align-items:baseline;justify-content:center;gap:8px">
    <span style="font-size:2.4rem;font-weight:700;color:##D63670;line-height:1">#cdDaysUntil#</span>
...
<div style="text-align:center;padding:16px 24px;border-bottom:1px solid rgba(0,0,0,0.1);font-family:'Jost',sans-serif">
  <span style="font-size:.68rem;letter-spacing:.35em;text-transform:uppercase;color:##D63670">Today Is The Day</span>
</div>
</cfif>
</cfoutput>
  ...
  <div class="hero-text">
    ...
    <img src="<cfoutput>#HTMLEditFormat(couplePhotoSrc)#</cfoutput>" alt="Couple photo" style="width:110px;height:110px;border-radius:50%;object-fit:cover;border:3px solid rgba(255,255,255,.5);box-shadow:0 4px 24px rgba(0,0,0,.4);display:block;margin:0 auto 20px">
    <span class="hero-script">Together Forever</span>
...
<section class="section" id="our_story">
  <div class="section-title">
    ...
    <h2>Our Story</h2>
    <span class="script-sub">love always finds a way</span>
    <div class="petal-rule"></div>
  </div>
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/rose-scatter.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
    <span class="eyebrow">You&rsquo;re Invited</span>
    <span class="script">with joy in our hearts</span>
...
<footer>
  <span class="script">forever &amp; always</span>
