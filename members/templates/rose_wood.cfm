<!---
  rose_wood.cfm - red roses on dark wood, full-page fixed background
  Palette: near-black #0A0605, charcoal #160C0A, cream #F5EDE8, crimson #C41830, muted rgba(245,237,232,.5)
--->
...
<style>
:root{--black:#0A0605;--charcoal:#160C0A;--cream:#F5EDE8;--crimson:#C41830;--muted:rgba(245,237,232,.5)}
...
.page-bg{
  ...
  inset:0;
  z-index:0;
  background-image:url('/assets/rose-wood.jpg');
...
nav{
  ...
  border-bottom:1px solid rgba(196,24,48,.2);
  text-align:center;
...
nav a{color:rgba(245,237,232,.6);text-decoration:none;font-size:.75rem;letter-spacing:.18em;text-transform:uppercase;display:inline-block;padding:18px 16px;border-bottom:2px solid transparent;transition:color .2s,border-color .2s;white-space:nowrap;font-family:'Jost',sans-serif}
nav a:hover,nav a.active{color:var(--cream);border-bottom-color:var(--crimson)}
...
.hero-eyebrow{font-size:.72rem;letter-spacing:.38em;text-transform:uppercase;color:var(--crimson);margin-bottom:20px;display:block;font-family:'Jost',sans-serif}
.hero-couple{font-family:'Great Vibes',cursive;font-size:clamp(3.8rem,9vw,7.5rem);color:var(--cream);line-height:1.1;margin-bottom:32px;text-shadow:0 2px 24px rgba(0,0,0,.6)}
.hero-rule{display:flex;align-items:center;justify-content:center;gap:16px;margin-bottom:24px}
.hero-rule .line{height:1px;width:60px;background:var(--crimson);opacity:.5}
.hero-rule .heart{color:var(--crimson);font-size:1rem}
.hero-date{font-size:.8rem;letter-spacing:.28em;text-transform:uppercase;color:var(--muted);margin-bottom:8px}
.hero-venue{font-size:.78rem;letter-spacing:.16em;text-transform:uppercase;color:rgba(196,24,48,.9)}

/* ---- DIVIDER ---- */
.divider{height:1px;background:rgba(196,24,48,.15);margin:0}

/* ---- SECTIONS ---- */
.section{padding:88px 56px;max-width:860px;margin:0 auto;text-align:center}
.section-dark{padding:88px 56px;background:rgba(10,6,5,.45);backdrop-filter:blur(6px)}
.section-dark .inner{max-width:860px;margin:0 auto;text-align:center}

.section-title{margin-bottom:52px}
.section-title .eyebrow{font-size:.75rem;letter-spacing:.28em;text-transform:uppercase;color:var(--crimson);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
...
.crimson-rule{display:flex;align-items:center;justify-content:center;gap:14px;margin-top:16px}
.crimson-rule .line{height:1px;width:44px;background:var(--crimson);opacity:.4}
.crimson-rule .dot{width:5px;height:5px;border-radius:50%;background:var(--crimson);opacity:.4}

/* ---- DETAILS ---- */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:rgba(196,24,48,.18);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:150px;padding:48px 32px;background:rgba(10,6,5,.5);text-align:center;backdrop-filter:blur(6px)}
.detail-block .lbl{font-size:.72rem;letter-spacing:.28em;text-transform:uppercase;color:var(--crimson);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
...
/* ---- STORY ---- */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2.1;color:rgba(245,237,232,.85);white-space:pre-wrap;font-style:italic;max-width:620px;margin:0 auto}
...
.g-photo img{width:100%;height:100%;object-fit:cover;transition:transform .5s,filter .3s;filter:brightness(.9) saturate(.9)}
.g-photo:hover img{transform:scale(1.05);filter:brightness(1) saturate(1.1)}

/* ---- FAQ ---- */
.faq-list{display:flex;flex-direction:column;max-width:640px;margin:0 auto;text-align:left}
.faq-item{padding:28px 0;border-bottom:1px solid rgba(196,24,48,.15)}
...
/* ---- TEXT ---- */
.text-body{font-size:1rem;color:rgba(245,237,232,.75);line-height:2;white-space:pre-wrap;max-width:600px;margin:0 auto}
.link-btn{display:inline-block;margin-top:28px;padding:13px 36px;border:1px solid var(--crimson);color:var(--crimson);text-decoration:none;font-size:.72rem;letter-spacing:.22em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--crimson);color:var(--cream)}
...
.rsvp-section .bg img{width:100%;height:100%;object-fit:cover;object-position:center top;filter:brightness(.18) saturate(.6)}
.rsvp-section .content{position:relative;z-index:2}
.rsvp-section .eyebrow{font-size:.75rem;letter-spacing:.28em;text-transform:uppercase;color:rgba(196,24,48,.9);display:block;margin-bottom:16px}
.rsvp-section .script{font-family:'Great Vibes',cursive;font-size:2.6rem;color:rgba(245,237,232,.85);display:block;margin-bottom:8px}
.rsvp-section h2{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(2.6rem,5vw,4.4rem);font-weight:300;color:var(--cream);margin-bottom:16px;letter-spacing:.03em;font-style:italic}
.rsvp-section p{color:var(--muted);margin-bottom:44px;max-width:400px;margin-left:auto;margin-right:auto;font-size:1rem;line-height:2}
.rsvp-btn{display:inline-block;padding:15px 56px;border:1px solid rgba(245,237,232,.6);color:var(--cream);font-size:.72rem;letter-spacing:.28em;text-transform:uppercase;text-decoration:none;font-family:'Jost',sans-serif;transition:background .25s,color .25s}
.rsvp-btn:hover{background:var(--cream);color:var(--black)}

/* ---- FOOTER ---- */
footer{text-align:center;padding:72px 24px;border-top:1px solid rgba(196,24,48,.15);background:rgba(10,6,5,.55);backdrop-filter:blur(12px)}
footer .names{font-family:'Great Vibes',cursive;font-size:2.8rem;color:var(--cream);margin-bottom:12px}
footer .date{font-size:.6rem;letter-spacing:.3em;text-transform:uppercase;color:var(--crimson)}
footer .credit{font-size:1.1rem;font-weight:500;font-weight:500;color:rgba(245,237,232,.15);margin-top:24px}

/* ---- LIGHTBOX ---- */
#lightbox{position:fixed;inset:0;background:rgba(10,6,5,.97);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#160C0A;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;gap:12px;border-bottom:1px solid rgba(196,24,48,.3)">
  <cfif isNumeric(url.siteId) AND url.siteId GT 0>
  <span style="opacity:.8">&#128065; Previewing your wedding site</span>
  <button onclick="window.close()" style="padding:8px 20px;background:rgba(255,255,255,.1);color:#fff;border:none;border-radius:4px;font-weight:600;cursor:pointer;font-size:13px">&times; Close Preview</button>
  <cfelse>
  <span style="opacity:.8">&#128065; Template preview &mdash; sample data shown</span>
  <a href="/members/wedding-site-edit.cfm?template=rose_wood" style="padding:8px 20px;background:#C41830;color:#fff;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
...
<div style="text-align:center;padding:18px 24px;border-bottom:1px solid rgba(0,0,0,0.1);font-family:'Jost',sans-serif">
  <span style="font-size:.6rem;letter-spacing:.4em;text-transform:uppercase;color:##C41830">Countdown</span>
  <div style="margin:6px 0;display:flex;align-items:baseline;justify-content:center;gap:8px">
    <span style="font-size:2.4rem;font-weight:700;color:##C41830;line-height:1">#cdDaysUntil#</span>
...
<div style="text-align:center;padding:16px 24px;border-bottom:1px solid rgba(0,0,0,0.1);font-family:'Jost',sans-serif">
  <span style="font-size:.68rem;letter-spacing:.35em;text-transform:uppercase;color:##C41830">Today Is The Day</span>
</div>
</cfif>
</cfoutput>
...
<section class="section" id="our_story">
  <div class="section-title">
    ...
    <h2>Our Story</h2>
    <div class="crimson-rule"><div class="line"></div><div class="dot"></div><div class="line"></div></div>
  </div>
...
<section class="rsvp-section" id="rsvp">
  <div class="bg">
    ...
    <cfelse>
    <img src="/assets/rose-wood.jpg" alt="" onerror="this.style.display='none'">
    </cfif>
  </div>
  <div class="content">
