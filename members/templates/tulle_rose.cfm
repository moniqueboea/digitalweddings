...
.hero-eyebrow{font-size:.68rem;letter-spacing:.38em;text-transform:uppercase;color:var(--taupe);margin-bottom:24px;display:block;font-family:'Jost',sans-serif}
...
/* ===== TEXT ===== */
.text-body{font-size:.92rem;color:var(--brown);line-height:2;white-space:pre-wrap;max-width:600px;margin:0 auto;opacity:.75}
