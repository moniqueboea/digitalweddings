<!---
  tulle_rose.cfm - cream roses on draped white tulle, blush_silk style
  Palette: cream #FDFBF8, ivory #F5F0E8, taupe #8A7A6E, warm-brown #3D2E26, petal #C8B4A0
--->
...
<style>
:root{--cream:#FDFBF8;--ivory:#F5F0E8;--ivory-dark:#E8DDD0;--petal:#C8B4A0;--taupe:#8A7A6E;--brown:#3D2E26;--muted:rgba(61,46,38,.42)}
*{margin:0;padding:0;box-sizing:border-box}
html{scroll-behavior:smooth}
body{background:var(--cream);color:var(--brown);font-family:'Jost',sans-serif;font-weight:300;line-height:1.7;overflow-x:hidden}

/* ===== HERO ===== */
.hero{position:relative;height:85vh;min-height:420px;display:flex;flex-direction:column;overflow:hidden}
.hero-bg{position:absolute;inset:0;background-image:url('/assets/tulle-rose.jpg');background-size:cover;background-position:center right;z-index:0}
.hero-overlay{position:absolute;inset:0;background:rgba(253,251,248,.12);z-index:1}

/* NAV */
nav{position:relative;z-index:10;text-align:center;border-bottom:1px solid rgba(200,180,160,.3);background:rgba(253,251,248,.72);backdrop-filter:blur(8px)}
...
nav a:hover,nav a.active{color:var(--brown);border-bottom-color:var(--petal)}

/* Sticky nav */
.sticky-nav{position:sticky;top:0;z-index:100;background:rgba(253,251,248,.97);border-bottom:1px solid var(--ivory-dark);display:none;text-align:center;backdrop-filter:blur(8px)}
...
.sticky-nav a:hover,.sticky-nav a.active{color:var(--brown);border-bottom-color:var(--petal)}

/* Hero text */
.hero-text{position:relative;z-index:5;flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:80px 24px}
.hero-eyebrow{font-size:1rem;letter-spacing:.38em;text-transform:uppercase;color:var(--taupe);margin-bottom:24px;display:block;font-family:'Jost',sans-serif}
.hero-couple{font-family:'Great Vibes',cursive;font-size:clamp(3.4rem,8vw,7rem);color:var(--brown);line-height:1.1;margin-bottom:28px;text-align:center}
.hero-rule{display:flex;align-items:center;justify-content:center;gap:16px;margin-bottom:22px}
.hero-rule .line{height:1px;width:56px;background:var(--petal);opacity:.6}
.hero-rule .star{color:var(--petal);font-size:.85rem}
.hero-date{font-size:.72rem;letter-spacing:.3em;text-transform:uppercase;color:var(--muted);margin-bottom:6px}
.hero-venue{font-size:.7rem;letter-spacing:.18em;text-transform:uppercase;color:rgba(138,122,110,.8)}

/* ===== SECTIONS ===== */
.section{padding:88px 56px;max-width:860px;margin:0 auto;text-align:center}
.section-ivory{background:var(--ivory);padding:88px 56px}
.section-ivory .inner{max-width:860px;margin:0 auto;text-align:center}
.divider{height:1px;background:var(--ivory-dark)}

.section-title{margin-bottom:52px}
.section-title .eyebrow{font-size:1rem;letter-spacing:.32em;text-transform:uppercase;color:var(--taupe);display:block;margin-bottom:12px;font-family:'Jost',sans-serif}
.section-title h2{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(2.2rem,4vw,3.2rem);font-weight:300;color:var(--brown);letter-spacing:.04em;font-style:italic}
.tulle-rule{display:flex;align-items:center;justify-content:center;gap:14px;margin-top:16px}
.tulle-rule .line{height:1px;width:44px;background:var(--petal);opacity:.45}
.tulle-rule .dot{width:5px;height:5px;border-radius:50%;background:var(--petal);opacity:.55}

/* ===== DETAILS ===== */
.details-grid{display:flex;flex-wrap:wrap;gap:1px;background:var(--ivory-dark);max-width:860px;margin:0 auto}
.detail-block{flex:1;min-width:150px;padding:48px 32px;background:var(--cream);text-align:center}
.detail-block .lbl{font-size:.62rem;letter-spacing:.32em;text-transform:uppercase;color:var(--taupe);margin-bottom:14px;display:block;font-family:'Jost',sans-serif}
.detail-block .val{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.7rem;font-weight:300;color:var(--brown);line-height:1.25;font-style:italic}
.detail-block .sub{font-size:.78rem;color:var(--muted);margin-top:8px}

/* ===== STORY ===== */
.story-body{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.25rem;font-weight:300;line-height:2.1;color:var(--brown);white-space:pre-wrap;font-style:italic;max-width:620px;margin:0 auto}
...
.faq-item{padding:28px 0;border-bottom:1px solid var(--ivory-dark)}
.faq-item .q{font-family:'Cormorant Garamond',Georgia,serif;font-size:1.15rem;font-weight:600;color:var(--brown);margin-bottom:8px;font-style:italic}
.faq-item .a{font-size:.88rem;color:var(--muted);line-height:1.9}

/* ===== TEXT ===== */
.text-body{font-size:1rem;color:var(--brown);line-height:2;white-space:pre-wrap;max-width:600px;margin:0 auto;opacity:.75}
.link-btn{display:inline-block;margin-top:28px;padding:13px 36px;border:1px solid var(--petal);color:var(--brown);text-decoration:none;font-size:.62rem;letter-spacing:.26em;text-transform:uppercase;font-family:'Jost',sans-serif;transition:background .2s,color .2s}
.link-btn:hover{background:var(--petal);color:var(--cream)}

/* ===== RSVP ===== */
.rsvp-section{position:relative;text-align:center;padding:0;overflow:hidden;min-height:480px;display:flex;align-items:center;justify-content:center}
.rsvp-bg{position:absolute;inset:0;background-image:url('/assets/tulle-rose.jpg');background-size:cover;background-position:center right;z-index:0;filter:brightness(1.04) saturate(.7)}
.rsvp-overlay{position:absolute;inset:0;background:rgba(253,251,248,.55);z-index:1}
.rsvp-content{position:relative;z-index:2;padding:100px 24px}
.rsvp-content .eyebrow{font-size:1rem;letter-spacing:.3em;text-transform:uppercase;color:var(--taupe);display:block;margin-bottom:16px}
.rsvp-content h2{font-family:'Cormorant Garamond',Georgia,serif;font-size:clamp(2.6rem,5vw,4.4rem);font-weight:300;color:var(--brown);margin-bottom:16px;letter-spacing:.03em;font-style:italic}
...
.rsvp-btn{display:inline-block;padding:15px 56px;background:var(--brown);color:var(--cream);font-size:.65rem;letter-spacing:.28em;text-transform:uppercase;text-decoration:none;font-family:'Jost',sans-serif;transition:background .25s}
.rsvp-btn:hover{background:var(--taupe)}

/* ===== FOOTER ===== */
footer{background:var(--cream);text-align:center;padding:72px 24px;border-top:1px solid var(--ivory-dark)}
footer .names{font-family:'Great Vibes',cursive;font-size:2.8rem;color:var(--brown);margin-bottom:12px}
footer .date{font-size:.6rem;letter-spacing:.3em;text-transform:uppercase;color:var(--taupe)}
footer .credit{font-size:1.1rem;font-weight:500;font-weight:500;color:rgba(61,46,38,.18);margin-top:24px}

/* ===== LIGHTBOX ===== */
#lightbox{position:fixed;inset:0;background:rgba(40,30,24,.97);z-index:999;display:none;align-items:center;justify-content:center;padding:20px}
...
@media(max-width:600px){
  .section,.section-ivory{padding:64px 24px}
...
<div style="position:fixed;top:0;left:0;right:0;z-index:9999;background:#3D2E26;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:12px 24px;font-family:Arial,sans-serif;font-size:13px;gap:12px">
  ...
  <a href="/members/wedding-site-edit.cfm?template=tulle_rose" style="padding:8px 20px;background:#C8B4A0;color:#3D2E26;border-radius:4px;font-weight:600;text-decoration:none;white-space:nowrap">Use This Template &rarr;</a>
  </cfif>
</div>
<div style="height:48px"></div>
</cfif>

<!--- HERO: full tulle-rose background --->
...
<section class="section" id="our_story">
  <div class="section-title">
    ...
    <h2>Our Story</h2>
    <div class="tulle-rule"><div class="line"></div><div class="dot"></div><div class="line"></div></div>
  </div>
...
<div class="divider"></div>
<div class="section-ivory" id="q_and_a">
  <div class="inner">
    <div class="section-title">
...
<div class="divider"></div>
<div class="section-ivory" id="travel">
  <div class="inner">
    <div class="section-title">
