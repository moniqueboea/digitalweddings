...
<cfcatch>
    <cflog file="digitalweddings_errors" type="error" text="upload-image failed: #cfcatch.message# USER=#session.user.id#">
    <cfset response['success'] = false>
    <cfset response['error'] = "Upload failed. Please try again.">
</cfcatch>
