...
<cfset site = {
    ...
    ceremony_start_time:       listFindNoCase(qSite.columnList,"ceremony_start_time") ? trim(qSite.ceremony_start_time) : "",
    ceremony_end_time:         listFindNoCase(qSite.columnList,"ceremony_end_time") ? trim(qSite.ceremony_end_time) : "",
    ...
    reception_start_time:      listFindNoCase(qSite.columnList,"reception_start_time") ? trim(qSite.reception_start_time) : "",
    reception_end_time:        listFindNoCase(qSite.columnList,"reception_end_time") ? trim(qSite.reception_end_time) : "",
