...
<cfquery name="vendors" datasource="#application.config.datasource#">
    SELECT v.vendor_id, v.business_name, v.category, v.description, v.location,
           v.phone, v.email, v.website, v.instagram_url, v.facebook_url, v.price_range, v.image_url, v.featured,
...
<section style="padding:60px 0">
    <div class="container">
        ...
        <p style="color:var(--text-muted);margin-bottom:36px">Discover talented Black-owned wedding vendors in your area.</p>

        <form method="get" action="/vendors.cfm" style="margin-bottom:40px;max-width:480px">
            <div class="field">
                <label>Search</label>
                    ...
                    <div class="card" style="padding:0;overflow:hidden;display:flex;flex-direction:row">
                        ...
                        <div style="padding:18px 20px;flex:1;min-width:0">
                            ...
                            <div style="display:flex;gap:8px;flex-wrap:wrap">
                                ...
                                <cfif len(website)><a href="/vendor-track.cfm?id=#vendor_id#&type=website_click&redirect=#URLEncodedFormat(trim(website))#" class="btn btn-ghost btn-sm" target="_blank" rel="noopener">Website</a></cfif>
...
<div id="contactModal" style="display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.55);align-items:center;justify-content:center;padding:20px">
    <div style="background:var(--bg);border:1px solid var(--border);border-radius:12px;width:100%;max-width:500px;box-shadow:0 8px 40px rgba(0,0,0,0.2)">
        ...
        <form method="post" action="/vendor-contact.cfm?return=/vendors.cfm" style="padding:24px">
            ...
            <div class="field">
                ...
                <input type="email" name="senderEmail" required placeholder="you@email.com">
            </div>
            <div class="field">
                <label>Message *</label>
